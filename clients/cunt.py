...
def updateclient():
    os.system('echo "Lets get Cunt updated for you." ; cd ~/cunt-blockchain ; . ./activate ; cunt stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:42099,18691,17458,18692,18690) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.cunt ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.cunt -t ~/plow/old-config/ ; rm -f --recursive -d ~/cunt-blockchain ; git clone https://github.com/Cunt-Network/cunt-blockchain.git ; cd ~/cunt-blockchain ; sh install.sh ; . ./activate ; cunt init ; cd ~/plow/old-config/.cunt/mainnet ; mv db wallet -t ~/.cunt/mainnet ; cd ~/cunt-blockchain ; cunt start farmer ; echo "Cunt has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.cunt/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Cunt uninstalled for you." ; cd ~/cunt-blockchain ; . ./activate ; cunt stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.cunt ; mv ~/.cunt -t ~/plow/old-config/ ; rm -f --recursive -d ~/cunt-blockchain ; echo "Cunt has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Cunt deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.cunt ; mv ~/.cunt -t ~/plow/old-config/ ; rm -f --recursive -d ~/cunt-blockchain ; echo "Cunt has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Cunt Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/cunt-blockchain ; . ./activate ; cunt keys show')
    
def mnemonic():
    os.system('echo "Getting Active Cunt Mnemonic Key..." ; cd ~/cunt-blockchain ; . ./activate ; cunt keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Cunt Mnemonic Key..." ; cd ~/cunt-blockchain ; . ./activate ; cunt generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Cunt Keys..." ; cd ~/cunt-blockchain ; . ./activate ; cunt keys add')
	
def genkey():
    os.system('echo "Generating New Cunt Mnemonic key..." ; cd ~/cunt-blockchain ; . ./activate ; cunt keys generate')

def stop():
    os.system('echo "Stopping Cunt..." ; cd ~/cunt-blockchain ; . ./activate ; cunt stop all')
	
def version():
    os.system('echo "Cunt Verion Number..." ; cd ~/cunt-blockchain ; . ./activate ; cunt version')

def startcli():
    os.system('echo "Starting Cunt..." ; cd ~/cunt-blockchain ; . ./activate ; cunt stop all ; deactivate ; cd ~/ ; cd ~/cunt-blockchain ; . ./activate ; cunt start farmer')

def chain():
    os.system('echo "Getting The State Of Cunt Blockchain..." ; cd ~/cunt-blockchain ; . ./activate ; cunt show -s')

def connections():
    os.system('echo "Getting Cunt Peer Connections..." ; cd ~/cunt-blockchain ; . ./activate ; cunt show -c')

def wallet():
    os.system('echo "Cunt Wallet Is Loading..." ; cd ~/cunt-blockchain ; . ./activate ; cunt wallet show')

def getaddress():
    os.system('echo "Getting Cunt Address..." ; cd ~/cunt-blockchain ; . ./activate ; cunt wallet get_address')

def gettransactions():
    os.system('echo "Getting Cunt Transactions..." ; cd ~/cunt-blockchain ; . ./activate ; cunt wallet get_transactions')
	
def summary():
    os.system('echo "Cunt Farm Summary Loading..." ; cd ~/cunt-blockchain ; . ./activate ; cunt farm summary')
	
def challenges():
    os.system('echo "Cunt Challenges Loading..." ; cd ~/cunt-blockchain ; . ./activate ; cunt farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Cunt Config File..." ; xdg-open ~/.cunt/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Cunt Log File..." ; xdg-open ~/.cunt/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Cunt-GUI..." ; cd ~/cunt-blockchain ; . ./activate ; cd cunt-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Cunt-GUI installed for you." ; cd ~/cunt-blockchain ; . ./activate ; sh install-gui.sh ; cd cunt-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Cunt Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:42099) ; echo "Process IDs On Daemon Port 42099 Closed"')             

def closefarmerport():
    os.system('echo "Closing Cunt Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:18692) ; echo "Process IDs On Farmer Port 18692 Closed"')

def closeharvesterport():
    os.system('echo "Closing Cunt Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:18691) ; echo "Process IDs On Harvester Port 18691 Closed"')

def closefullnodeport():
    os.system('echo "Closing Cunt Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:18690) ; echo "Process IDs On Full Node Port 18690 Closed"')

def closewalletport():
    os.system('echo "Closing Cunt Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:17458) ; echo "Process IDs on Wallet Port 17458 Closed"')

def listports():
    os.system('echo "List of All Cunt Process IDs for Ports, Daemon 42099, Harvester 18691, Wallet 17458, Farmer 18692, Full Node 18690." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:42099,18691,17458,18692,18690')

def closeallport():
    os.system('echo "Closing All Cunt Ports..." ; sudo kill -9 $(sudo lsof -t -i:42099,18691,17458,18692,18690) ; echo "All Process IDs on Ports, Daemon 42099, Harvester 18691, Wallet 17458, Farmer 18692, Full Node 18690, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Cunt Folder" ; cd ~/cunt-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_CuntWindow(object):
    def setupUi(self, CuntWindow):
        CuntWindow.setObjectName("CuntWindow")
        CuntWindow.resize(483, 320)
...
#START MAIN WINDOW
        CuntWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        CuntWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(CuntWindow)
...
#TAB LAYOUT
        ...
        CuntWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(CuntWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(CuntWindow)

    def retranslateUi(self, CuntWindow):
        _translate = QtCore.QCoreApplication.translate
        CuntWindow.setWindowTitle(_translate("CuntWindow", "Cunt"))
        self.connections.setText(_translate("CuntWindow", "Connections"))
        self.summary.setText(_translate("CuntWindow", "Farm Summary"))
        self.config.setText(_translate("CuntWindow", "Config"))
        self.wallet.setText(_translate("CuntWindow", "Show Cunt Wallet"))
        self.chain.setText(_translate("CuntWindow", "State Of Cunt"))
        self.startcli.setText(_translate("CuntWindow", "Start-CLI"))
        self.startgui.setText(_translate("CuntWindow", "Start-GUI"))
        self.log.setText(_translate("CuntWindow", "Log"))
        self.challenges.setText(_translate("CuntWindow", "Challenges"))
        self.stop.setText(_translate("CuntWindow", "Stop"))
        self.terminal.setText(_translate("CuntWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("CuntWindow", "Dashboard"))
        self.genkey.setText(_translate("CuntWindow", "Generate Key"))
        self.gettransactions.setText(_translate("CuntWindow", "Get Transactions"))
        self.getaddress.setText(_translate("CuntWindow", "Get Address"))
        self.mnemonic.setText(_translate("CuntWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("CuntWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("CuntWindow", "Add Key"))
        self.keysshow.setText(_translate("CuntWindow", "Cunt Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("CuntWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("CuntWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("CuntWindow", "Close Full-Node 18690"))
        self.listports.setText(_translate("CuntWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("CuntWindow", "Close Farmer 18692"))
        self.closewalletport.setText(_translate("CuntWindow", "Close Wallet 17458"))
        self.closeharvesterport.setText(_translate("CuntWindow", "Close Harvester 18691"))
        self.closedaemonport.setText(_translate("CuntWindow", "Close Daemon 42099"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("CuntWindow", "Ports"))
        self.installcli.setText(_translate("CuntWindow", "Install CLI"))
        self.installgui.setText(_translate("CuntWindow", "Install GUI"))
        self.version.setText(_translate("CuntWindow", "Cunt Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("CuntWindow", "Install"))
        self.uninstallclient.setText(_translate("CuntWindow", "UnInstall Cunt"))
        self.updateclient.setText(_translate("CuntWindow", "Update Cunt"))
        self.deleteclient.setText(_translate("CuntWindow", "Delete Cunt"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("CuntWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    CuntWindow = QtWidgets.QMainWindow()
    ui = Ui_CuntWindow()
    ui.setupUi(CuntWindow)
    CuntWindow.show()
    sys.exit(app.exec_()) 
