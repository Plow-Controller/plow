...
def updateclient():
    os.system('echo "Lets get Shamrock updated for you." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:55333,9338,9441,9337,9359) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.shamrock ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.shamrock -t ~/plow/old-config/ ; rm -f --recursive -d ~/shamrock-blockchain ; git clone https://github.com/Shamrock-Network/shamrock-blockchain.git ; cd ~/shamrock-blockchain ; sh install.sh ; . ./activate ; shamrock init ; cd ~/plow/old-config/.shamrock/mainnet ; mv db wallet -t ~/.shamrock/mainnet ; cd ~/shamrock-blockchain ; shamrock start farmer ; echo "Shamrock has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.shamrock/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Shamrock uninstalled for you." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.shamrock ; mv ~/.shamrock -t ~/plow/old-config/ ; rm -f --recursive -d ~/shamrock-blockchain ; echo "Shamrock has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Shamrock deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.shamrock ; mv ~/.shamrock -t ~/plow/old-config/ ; rm -f --recursive -d ~/shamrock-blockchain ; echo "Shamrock has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Shamrock Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock keys show')
    
def mnemonic():
    os.system('echo "Getting Active Shamrock Mnemonic Key..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Shamrock Mnemonic Key..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Shamrock Keys..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock keys add')
	
def genkey():
    os.system('echo "Generating New Shamrock Mnemonic key..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock keys generate')

def stop():
    os.system('echo "Stopping Shamrock..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock stop all')
	
def version():
    os.system('echo "Shamrock Verion Number..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock version')

def startcli():
    os.system('echo "Starting Shamrock..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock stop all ; deactivate ; cd ~/ ; cd ~/shamrock-blockchain ; . ./activate ; shamrock start farmer')

def chain():
    os.system('echo "Getting The State Of Shamrock Blockchain..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock show -s')

def connections():
    os.system('echo "Getting Shamrock Peer Connections..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock show -c')

def wallet():
    os.system('echo "Shamrock Wallet Is Loading..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock wallet show')

def getaddress():
    os.system('echo "Getting Shamrock Address..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock wallet get_address')

def gettransactions():
    os.system('echo "Getting Shamrock Transactions..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock wallet get_transactions')
	
def summary():
    os.system('echo "Shamrock Farm Summary Loading..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock farm summary')
	
def challenges():
    os.system('echo "Shamrock Challenges Loading..." ; cd ~/shamrock-blockchain ; . ./activate ; shamrock farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Shamrock Config File..." ; xdg-open ~/.shamrock/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Shamrock Log File..." ; xdg-open ~/.shamrock/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Shamrock-GUI..." ; cd ~/shamrock-blockchain ; . ./activate ; cd shamrock-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Shamrock-GUI installed for you." ; cd ~/shamrock-blockchain ; . ./activate ; sh install-gui.sh ; cd shamrock-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Shamrock Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:55333) ; echo "Process IDs On Daemon Port 55333 Closed"')             

def closefarmerport():
    os.system('echo "Closing Shamrock Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:9337) ; echo "Process IDs On Farmer Port 9337 Closed"')

def closeharvesterport():
    os.system('echo "Closing Shamrock Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:9338) ; echo "Process IDs On Harvester Port 9338 Closed"')

def closefullnodeport():
    os.system('echo "Closing Shamrock Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:9359) ; echo "Process IDs On Full Node Port 9359 Closed"')

def closewalletport():
    os.system('echo "Closing Shamrock Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:9441) ; echo "Process IDs on Wallet Port 9441 Closed"')

def listports():
    os.system('echo "List of All Shamrock Process IDs for Ports, Daemon 55333, Harvester 9338, Wallet 9441, Farmer 9337, Full Node 9359." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:55333,9338,9441,9337,9359')

def closeallport():
    os.system('echo "Closing All Shamrock Ports..." ; sudo kill -9 $(sudo lsof -t -i:55333,9338,9441,9337,9359) ; echo "All Process IDs on Ports, Daemon 55333, Harvester 9338, Wallet 9441, Farmer 9337, Full Node 9359, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Shamrock Folder" ; cd ~/shamrock-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_ShamrockWindow(object):
    def setupUi(self, ShamrockWindow):
        ShamrockWindow.setObjectName("ShamrockWindow")
        ShamrockWindow.resize(483, 320)
...
#START MAIN WINDOW
        ShamrockWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ShamrockWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(ShamrockWindow)
...
#TAB LAYOUT
        ...
        ShamrockWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(ShamrockWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(ShamrockWindow)

    def retranslateUi(self, ShamrockWindow):
        _translate = QtCore.QCoreApplication.translate
        ShamrockWindow.setWindowTitle(_translate("ShamrockWindow", "Shamrock"))
        self.connections.setText(_translate("ShamrockWindow", "Connections"))
        self.summary.setText(_translate("ShamrockWindow", "Farm Summary"))
        self.config.setText(_translate("ShamrockWindow", "Config"))
        self.wallet.setText(_translate("ShamrockWindow", "Show Shamrock Wallet"))
        self.chain.setText(_translate("ShamrockWindow", "State Of Shamrock"))
        self.startcli.setText(_translate("ShamrockWindow", "Start-CLI"))
        self.startgui.setText(_translate("ShamrockWindow", "Start-GUI"))
        self.log.setText(_translate("ShamrockWindow", "Log"))
        self.challenges.setText(_translate("ShamrockWindow", "Challenges"))
        self.stop.setText(_translate("ShamrockWindow", "Stop"))
        self.terminal.setText(_translate("ShamrockWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("ShamrockWindow", "Dashboard"))
        self.genkey.setText(_translate("ShamrockWindow", "Generate Key"))
        self.gettransactions.setText(_translate("ShamrockWindow", "Get Transactions"))
        self.getaddress.setText(_translate("ShamrockWindow", "Get Address"))
        self.mnemonic.setText(_translate("ShamrockWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("ShamrockWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("ShamrockWindow", "Add Key"))
        self.keysshow.setText(_translate("ShamrockWindow", "Shamrock Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("ShamrockWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("ShamrockWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("ShamrockWindow", "Close Full-Node 9359"))
        self.listports.setText(_translate("ShamrockWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("ShamrockWindow", "Close Farmer 9337"))
        self.closewalletport.setText(_translate("ShamrockWindow", "Close Wallet 9441"))
        self.closeharvesterport.setText(_translate("ShamrockWindow", "Close Harvester 9338"))
        self.closedaemonport.setText(_translate("ShamrockWindow", "Close Daemon 55333"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("ShamrockWindow", "Ports"))
        self.installcli.setText(_translate("ShamrockWindow", "Install CLI"))
        self.installgui.setText(_translate("ShamrockWindow", "Install GUI"))
        self.version.setText(_translate("ShamrockWindow", "Shamrock Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("ShamrockWindow", "Install"))
        self.uninstallclient.setText(_translate("ShamrockWindow", "UnInstall Shamrock"))
        self.updateclient.setText(_translate("ShamrockWindow", "Update Shamrock"))
        self.deleteclient.setText(_translate("ShamrockWindow", "Delete Shamrock"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("ShamrockWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ShamrockWindow = QtWidgets.QMainWindow()
    ui = Ui_ShamrockWindow()
    ui.setupUi(ShamrockWindow)
    ShamrockWindow.show()
    sys.exit(app.exec_()) 
