...
def updateclient():
    os.system('echo "Lets get Thyme updated for you." ; cd ~/thyme-blockchain ; . ./activate ; thyme stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:6600,16884,16883,16885,16988) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.thyme ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.thyme -t ~/plow/old-config/ ; rm -f --recursive -d ~/thyme-blockchain ; git clone https://github.com/Thyme-Network/thyme-blockchain.git ; cd ~/thyme-blockchain ; sh install.sh ; . ./activate ; thyme init ; cd ~/plow/old-config/.thyme/mainnet ; mv db wallet -t ~/.thyme/mainnet ; cd ~/thyme-blockchain ; thyme start farmer ; echo "Thyme has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.thyme/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Thyme uninstalled for you." ; cd ~/thyme-blockchain ; . ./activate ; thyme stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.thyme ; mv ~/.thyme -t ~/plow/old-config/ ; rm -f --recursive -d ~/thyme-blockchain ; echo "Thyme has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Thyme deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.thyme ; mv ~/.thyme -t ~/plow/old-config/ ; rm -f --recursive -d ~/thyme-blockchain ; echo "Thyme has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Thyme Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/thyme-blockchain ; . ./activate ; thyme keys show')
    
def mnemonic():
    os.system('echo "Getting Active Thyme Mnemonic Key..." ; cd ~/thyme-blockchain ; . ./activate ; thyme keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Thyme Mnemonic Key..." ; cd ~/thyme-blockchain ; . ./activate ; thyme generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Thyme Keys..." ; cd ~/thyme-blockchain ; . ./activate ; thyme keys add')
	
def genkey():
    os.system('echo "Generating New Thyme Mnemonic key..." ; cd ~/thyme-blockchain ; . ./activate ; thyme keys generate')

def stop():
    os.system('echo "Stopping Thyme..." ; cd ~/thyme-blockchain ; . ./activate ; thyme stop all')
	
def version():
    os.system('echo "Thyme Verion Number..." ; cd ~/thyme-blockchain ; . ./activate ; thyme version')

def startcli():
    os.system('echo "Starting Thyme..." ; cd ~/thyme-blockchain ; . ./activate ; thyme stop all ; deactivate ; cd ~/ ; cd ~/thyme-blockchain ; . ./activate ; thyme start farmer')

def chain():
    os.system('echo "Getting The State Of Thyme Blockchain..." ; cd ~/thyme-blockchain ; . ./activate ; thyme show -s')

def connections():
    os.system('echo "Getting Thyme Peer Connections..." ; cd ~/thyme-blockchain ; . ./activate ; thyme show -c')

def wallet():
    os.system('echo "Thyme Wallet Is Loading..." ; cd ~/thyme-blockchain ; . ./activate ; thyme wallet show')

def getaddress():
    os.system('echo "Getting Thyme Address..." ; cd ~/thyme-blockchain ; . ./activate ; thyme wallet get_address')

def gettransactions():
    os.system('echo "Getting Thyme Transactions..." ; cd ~/thyme-blockchain ; . ./activate ; thyme wallet get_transactions')
	
def summary():
    os.system('echo "Thyme Farm Summary Loading..." ; cd ~/thyme-blockchain ; . ./activate ; thyme farm summary')
	
def challenges():
    os.system('echo "Thyme Challenges Loading..." ; cd ~/thyme-blockchain ; . ./activate ; thyme farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Thyme Config File..." ; xdg-open ~/.thyme/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Thyme Log File..." ; xdg-open ~/.thyme/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Thyme-GUI..." ; cd ~/thyme-blockchain ; . ./activate ; cd thyme-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Thyme-GUI installed for you." ; cd ~/thyme-blockchain ; . ./activate ; sh install-gui.sh ; cd thyme-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Thyme Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:6600) ; echo "Process IDs On Daemon Port 6600 Closed"')             

def closefarmerport():
    os.system('echo "Closing Thyme Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:16885) ; echo "Process IDs On Farmer Port 16885 Closed"')

def closeharvesterport():
    os.system('echo "Closing Thyme Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:16884) ; echo "Process IDs On Harvester Port 16884 Closed"')

def closefullnodeport():
    os.system('echo "Closing Thyme Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:16988) ; echo "Process IDs On Full Node Port 16988 Closed"')

def closewalletport():
    os.system('echo "Closing Thyme Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:16883) ; echo "Process IDs on Wallet Port 16883 Closed"')

def listports():
    os.system('echo "List of All Thyme Process IDs for Ports, Daemon 6600, Harvester 16884, Wallet 16883, Farmer 16885, Full Node 16988." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:6600,16884,16883,16885,16988')

def closeallport():
    os.system('echo "Closing All Thyme Ports..." ; sudo kill -9 $(sudo lsof -t -i:6600,16884,16883,16885,16988) ; echo "All Process IDs on Ports, Daemon 6600, Harvester 16884, Wallet 16883, Farmer 16885, Full Node 16988, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Thyme Folder" ; cd ~/thyme-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_ThymeWindow(object):
    def setupUi(self, ThymeWindow):
        ThymeWindow.setObjectName("ThymeWindow")
        ThymeWindow.resize(483, 320)
...
#START MAIN WINDOW
        ThymeWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ThymeWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(ThymeWindow)
...
#TAB LAYOUT
        ...
        ThymeWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(ThymeWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(ThymeWindow)

    def retranslateUi(self, ThymeWindow):
        _translate = QtCore.QCoreApplication.translate
        ThymeWindow.setWindowTitle(_translate("ThymeWindow", "Thyme"))
        self.connections.setText(_translate("ThymeWindow", "Connections"))
        self.summary.setText(_translate("ThymeWindow", "Farm Summary"))
        self.config.setText(_translate("ThymeWindow", "Config"))
        self.wallet.setText(_translate("ThymeWindow", "Show Thyme Wallet"))
        self.chain.setText(_translate("ThymeWindow", "State Of Thyme"))
        self.startcli.setText(_translate("ThymeWindow", "Start-CLI"))
        self.startgui.setText(_translate("ThymeWindow", "Start-GUI"))
        self.log.setText(_translate("ThymeWindow", "Log"))
        self.challenges.setText(_translate("ThymeWindow", "Challenges"))
        self.stop.setText(_translate("ThymeWindow", "Stop"))
        self.terminal.setText(_translate("ThymeWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("ThymeWindow", "Dashboard"))
        self.genkey.setText(_translate("ThymeWindow", "Generate Key"))
        self.gettransactions.setText(_translate("ThymeWindow", "Get Transactions"))
        self.getaddress.setText(_translate("ThymeWindow", "Get Address"))
        self.mnemonic.setText(_translate("ThymeWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("ThymeWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("ThymeWindow", "Add Key"))
        self.keysshow.setText(_translate("ThymeWindow", "Thyme Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("ThymeWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("ThymeWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("ThymeWindow", "Close Full-Node 16988"))
        self.listports.setText(_translate("ThymeWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("ThymeWindow", "Close Farmer 16885"))
        self.closewalletport.setText(_translate("ThymeWindow", "Close Wallet 16883"))
        self.closeharvesterport.setText(_translate("ThymeWindow", "Close Harvester 16884"))
        self.closedaemonport.setText(_translate("ThymeWindow", "Close Daemon 6600"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("ThymeWindow", "Ports"))
        self.installcli.setText(_translate("ThymeWindow", "Install CLI"))
        self.installgui.setText(_translate("ThymeWindow", "Install GUI"))
        self.version.setText(_translate("ThymeWindow", "Thyme Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("ThymeWindow", "Install"))
        self.uninstallclient.setText(_translate("ThymeWindow", "UnInstall Thyme"))
        self.updateclient.setText(_translate("ThymeWindow", "Update Thyme"))
        self.deleteclient.setText(_translate("ThymeWindow", "Delete Thyme"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("ThymeWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ThymeWindow = QtWidgets.QMainWindow()
    ui = Ui_ThymeWindow()
    ui.setupUi(ThymeWindow)
    ThymeWindow.show()
    sys.exit(app.exec_()) 
