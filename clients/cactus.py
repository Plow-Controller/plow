...
def updateclient():
    os.system('echo "Lets get Cactus updated for you." ; cd ~/cactus-blockchain ; . ./activate ; cactus stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:58400,11448,0005,11447,0004) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.cactus ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.cactus -t ~/plow/old-config/ ; rm -f --recursive -d ~/cactus-blockchain ; git clone https://github.com/Cactus-Network/cactus-blockchain.git ; cd ~/cactus-blockchain ; sh install.sh ; . ./activate ; cactus init ; cd ~/plow/old-config/.cactus/mainnet ; mv db wallet -t ~/.cactus/mainnet ; cd ~/cactus-blockchain ; cactus start farmer ; echo "Cactus has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.cactus/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Cactus uninstalled for you." ; cd ~/cactus-blockchain ; . ./activate ; cactus stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.cactus ; mv ~/.cactus -t ~/plow/old-config/ ; rm -f --recursive -d ~/cactus-blockchain ; echo "Cactus has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Cactus deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.cactus ; mv ~/.cactus -t ~/plow/old-config/ ; rm -f --recursive -d ~/cactus-blockchain ; echo "Cactus has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Cactus Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/cactus-blockchain ; . ./activate ; cactus keys show')
    
def mnemonic():
    os.system('echo "Getting Active Cactus Mnemonic Key..." ; cd ~/cactus-blockchain ; . ./activate ; cactus keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Cactus Mnemonic Key..." ; cd ~/cactus-blockchain ; . ./activate ; cactus generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Cactus Keys..." ; cd ~/cactus-blockchain ; . ./activate ; cactus keys add')
	
def genkey():
    os.system('echo "Generating New Cactus Mnemonic key..." ; cd ~/cactus-blockchain ; . ./activate ; cactus keys generate')

def stop():
    os.system('echo "Stopping Cactus..." ; cd ~/cactus-blockchain ; . ./activate ; cactus stop all')
	
def version():
    os.system('echo "Cactus Verion Number..." ; cd ~/cactus-blockchain ; . ./activate ; cactus version')

def startcli():
    os.system('echo "Starting Cactus..." ; cd ~/cactus-blockchain ; . ./activate ; cactus stop all ; deactivate ; cd ~/ ; cd ~/cactus-blockchain ; . ./activate ; cactus start farmer')

def chain():
    os.system('echo "Getting The State Of Cactus Blockchain..." ; cd ~/cactus-blockchain ; . ./activate ; cactus show -s')

def connections():
    os.system('echo "Getting Cactus Peer Connections..." ; cd ~/cactus-blockchain ; . ./activate ; cactus show -c')

def wallet():
    os.system('echo "Cactus Wallet Is Loading..." ; cd ~/cactus-blockchain ; . ./activate ; cactus wallet show')

def getaddress():
    os.system('echo "Getting Cactus Address..." ; cd ~/cactus-blockchain ; . ./activate ; cactus wallet get_address')

def gettransactions():
    os.system('echo "Getting Cactus Transactions..." ; cd ~/cactus-blockchain ; . ./activate ; cactus wallet get_transactions')
	
def summary():
    os.system('echo "Cactus Farm Summary Loading..." ; cd ~/cactus-blockchain ; . ./activate ; cactus farm summary')
	
def challenges():
    os.system('echo "Cactus Challenges Loading..." ; cd ~/cactus-blockchain ; . ./activate ; cactus farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Cactus Config File..." ; xdg-open ~/.cactus/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Cactus Log File..." ; xdg-open ~/.cactus/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Cactus-GUI..." ; cd ~/cactus-blockchain ; . ./activate ; cd cactus-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Cactus-GUI installed for you." ; cd ~/cactus-blockchain ; . ./activate ; sh install-gui.sh ; cd cactus-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Cactus Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:58400) ; echo "Process IDs On Daemon Port 58400 Closed"')             

def closefarmerport():
    os.system('echo "Closing Cactus Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:11447) ; echo "Process IDs On Farmer Port 11447 Closed"')

def closeharvesterport():
    os.system('echo "Closing Cactus Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:11448) ; echo "Process IDs On Harvester Port 11448 Closed"')

def closefullnodeport():
    os.system('echo "Closing Cactus Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:0004) ; echo "Process IDs On Full Node Port 0004 Closed"')

def closewalletport():
    os.system('echo "Closing Cactus Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:0005) ; echo "Process IDs on Wallet Port 0005 Closed"')

def listports():
    os.system('echo "List of All Cactus Process IDs for Ports, Daemon 58400, Harvester 11448, Wallet 0005, Farmer 11447, Full Node 0004." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:58400,11448,0005,11447,0004')

def closeallport():
    os.system('echo "Closing All Cactus Ports..." ; sudo kill -9 $(sudo lsof -t -i:58400,11448,0005,11447,0004) ; echo "All Process IDs on Ports, Daemon 58400, Harvester 11448, Wallet 0005, Farmer 11447, Full Node 0004, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Cactus Folder" ; cd ~/cactus-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_CactusWindow(object):
    def setupUi(self, CactusWindow):
        CactusWindow.setObjectName("CactusWindow")
        CactusWindow.resize(483, 320)
...
#START MAIN WINDOW
        CactusWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        CactusWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(CactusWindow)
...
#TAB LAYOUT
        ...
        CactusWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(CactusWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(CactusWindow)

    def retranslateUi(self, CactusWindow):
        _translate = QtCore.QCoreApplication.translate
        CactusWindow.setWindowTitle(_translate("CactusWindow", "Cactus"))
        self.connections.setText(_translate("CactusWindow", "Connections"))
        self.summary.setText(_translate("CactusWindow", "Farm Summary"))
        self.config.setText(_translate("CactusWindow", "Config"))
        self.wallet.setText(_translate("CactusWindow", "Show Cactus Wallet"))
        self.chain.setText(_translate("CactusWindow", "State Of Cactus"))
        self.startcli.setText(_translate("CactusWindow", "Start-CLI"))
        self.startgui.setText(_translate("CactusWindow", "Start-GUI"))
        self.log.setText(_translate("CactusWindow", "Log"))
        self.challenges.setText(_translate("CactusWindow", "Challenges"))
        self.stop.setText(_translate("CactusWindow", "Stop"))
        self.terminal.setText(_translate("CactusWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("CactusWindow", "Dashboard"))
        self.genkey.setText(_translate("CactusWindow", "Generate Key"))
        self.gettransactions.setText(_translate("CactusWindow", "Get Transactions"))
        self.getaddress.setText(_translate("CactusWindow", "Get Address"))
        self.mnemonic.setText(_translate("CactusWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("CactusWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("CactusWindow", "Add Key"))
        self.keysshow.setText(_translate("CactusWindow", "Cactus Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("CactusWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("CactusWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("CactusWindow", "Close Full-Node 0004"))
        self.listports.setText(_translate("CactusWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("CactusWindow", "Close Farmer 11447"))
        self.closewalletport.setText(_translate("CactusWindow", "Close Wallet 0005"))
        self.closeharvesterport.setText(_translate("CactusWindow", "Close Harvester 11448"))
        self.closedaemonport.setText(_translate("CactusWindow", "Close Daemon 58400"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("CactusWindow", "Ports"))
        self.installcli.setText(_translate("CactusWindow", "Install CLI"))
        self.installgui.setText(_translate("CactusWindow", "Install GUI"))
        self.version.setText(_translate("CactusWindow", "Cactus Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("CactusWindow", "Install"))
        self.uninstallclient.setText(_translate("CactusWindow", "UnInstall Cactus"))
        self.updateclient.setText(_translate("CactusWindow", "Update Cactus"))
        self.deleteclient.setText(_translate("CactusWindow", "Delete Cactus"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("CactusWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    CactusWindow = QtWidgets.QMainWindow()
    ui = Ui_CactusWindow()
    ui.setupUi(CactusWindow)
    CactusWindow.show()
    sys.exit(app.exec_()) 
