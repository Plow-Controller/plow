...
def updateclient():
    os.system('echo "Lets get Socks updated for you." ; cd ~/socks-blockchain ; . ./activate ; socks stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:55500,58448,58449,58447,58444) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.socks ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.socks -t ~/plow/old-config/ ; rm -f --recursive -d ~/socks-blockchain ; git clone https://bitbucket.org/Socks-Network/socks-blockchain.git ; cd ~/socks-blockchain ; sh install.sh ; . ./activate ; socks init ; cd ~/plow/old-config/.socks/mainnet ; mv db wallet -t ~/.socks/mainnet ; cd ~/socks-blockchain ; socks start farmer ; echo "Socks has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.socks/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Socks uninstalled for you." ; cd ~/socks-blockchain ; . ./activate ; socks stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.socks ; mv ~/.socks -t ~/plow/old-config/ ; rm -f --recursive -d ~/socks-blockchain ; echo "Socks has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Socks deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.socks ; mv ~/.socks -t ~/plow/old-config/ ; rm -f --recursive -d ~/socks-blockchain ; echo "Socks has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Socks Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/socks-blockchain ; . ./activate ; socks keys show')
    
def mnemonic():
    os.system('echo "Getting Active Socks Mnemonic Key..." ; cd ~/socks-blockchain ; . ./activate ; socks keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Socks Mnemonic Key..." ; cd ~/socks-blockchain ; . ./activate ; socks generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Socks Keys..." ; cd ~/socks-blockchain ; . ./activate ; socks keys add')
	
def genkey():
    os.system('echo "Generating New Socks Mnemonic key..." ; cd ~/socks-blockchain ; . ./activate ; socks keys generate')

def stop():
    os.system('echo "Stopping Socks..." ; cd ~/socks-blockchain ; . ./activate ; socks stop all')
	
def version():
    os.system('echo "Socks Verion Number..." ; cd ~/socks-blockchain ; . ./activate ; socks version')

def startcli():
    os.system('echo "Starting Socks..." ; cd ~/socks-blockchain ; . ./activate ; socks stop all ; deactivate ; cd ~/ ; cd ~/socks-blockchain ; . ./activate ; socks start farmer')

def chain():
    os.system('echo "Getting The State Of Socks Blockchain..." ; cd ~/socks-blockchain ; . ./activate ; socks show -s')

def connections():
    os.system('echo "Getting Socks Peer Connections..." ; cd ~/socks-blockchain ; . ./activate ; socks show -c')

def wallet():
    os.system('echo "Socks Wallet Is Loading..." ; cd ~/socks-blockchain ; . ./activate ; socks wallet show')

def getaddress():
    os.system('echo "Getting Socks Address..." ; cd ~/socks-blockchain ; . ./activate ; socks wallet get_address')

def gettransactions():
    os.system('echo "Getting Socks Transactions..." ; cd ~/socks-blockchain ; . ./activate ; socks wallet get_transactions')
	
def summary():
    os.system('echo "Socks Farm Summary Loading..." ; cd ~/socks-blockchain ; . ./activate ; socks farm summary')
	
def challenges():
    os.system('echo "Socks Challenges Loading..." ; cd ~/socks-blockchain ; . ./activate ; socks farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Socks Config File..." ; xdg-open ~/.socks/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Socks Log File..." ; xdg-open ~/.socks/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Socks-GUI..." ; cd ~/socks-blockchain ; . ./activate ; cd socks-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Socks-GUI installed for you." ; cd ~/socks-blockchain ; . ./activate ; sh install-gui.sh ; cd socks-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Socks Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:55500) ; echo "Process IDs On Daemon Port 55500 Closed"')             

def closefarmerport():
    os.system('echo "Closing Socks Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:58447) ; echo "Process IDs On Farmer Port 58447 Closed"')

def closeharvesterport():
    os.system('echo "Closing Socks Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:58448) ; echo "Process IDs On Harvester Port 58448 Closed"')

def closefullnodeport():
    os.system('echo "Closing Socks Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:58444) ; echo "Process IDs On Full Node Port 58444 Closed"')

def closewalletport():
    os.system('echo "Closing Socks Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:58449) ; echo "Process IDs on Wallet Port 58449 Closed"')

def listports():
    os.system('echo "List of All Socks Process IDs for Ports, Daemon 55500, Harvester 58448, Wallet 58449, Farmer 58447, Full Node 58444." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:55500,58448,58449,58447,58444')

def closeallport():
    os.system('echo "Closing All Socks Ports..." ; sudo kill -9 $(sudo lsof -t -i:55500,58448,58449,58447,58444) ; echo "All Process IDs on Ports, Daemon 55500, Harvester 58448, Wallet 58449, Farmer 58447, Full Node 58444, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Socks Folder" ; cd ~/socks-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_SocksWindow(object):
    def setupUi(self, SocksWindow):
        SocksWindow.setObjectName("SocksWindow")
        SocksWindow.resize(483, 320)
...
#START MAIN WINDOW
        SocksWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SocksWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(SocksWindow)
...
#TAB LAYOUT
        ...
        SocksWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(SocksWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(SocksWindow)

    def retranslateUi(self, SocksWindow):
        _translate = QtCore.QCoreApplication.translate
        SocksWindow.setWindowTitle(_translate("SocksWindow", "Socks"))
        self.connections.setText(_translate("SocksWindow", "Connections"))
        self.summary.setText(_translate("SocksWindow", "Farm Summary"))
        self.config.setText(_translate("SocksWindow", "Config"))
        self.wallet.setText(_translate("SocksWindow", "Show Socks Wallet"))
        self.chain.setText(_translate("SocksWindow", "State Of Socks"))
        self.startcli.setText(_translate("SocksWindow", "Start-CLI"))
        self.startgui.setText(_translate("SocksWindow", "Start-GUI"))
        self.log.setText(_translate("SocksWindow", "Log"))
        self.challenges.setText(_translate("SocksWindow", "Challenges"))
        self.stop.setText(_translate("SocksWindow", "Stop"))
        self.terminal.setText(_translate("SocksWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("SocksWindow", "Dashboard"))
        self.genkey.setText(_translate("SocksWindow", "Generate Key"))
        self.gettransactions.setText(_translate("SocksWindow", "Get Transactions"))
        self.getaddress.setText(_translate("SocksWindow", "Get Address"))
        self.mnemonic.setText(_translate("SocksWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("SocksWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("SocksWindow", "Add Key"))
        self.keysshow.setText(_translate("SocksWindow", "Socks Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("SocksWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("SocksWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("SocksWindow", "Close Full-Node 58444"))
        self.listports.setText(_translate("SocksWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("SocksWindow", "Close Farmer 58447"))
        self.closewalletport.setText(_translate("SocksWindow", "Close Wallet 58449"))
        self.closeharvesterport.setText(_translate("SocksWindow", "Close Harvester 58448"))
        self.closedaemonport.setText(_translate("SocksWindow", "Close Daemon 55500"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("SocksWindow", "Ports"))
        self.installcli.setText(_translate("SocksWindow", "Install CLI"))
        self.installgui.setText(_translate("SocksWindow", "Install GUI"))
        self.version.setText(_translate("SocksWindow", "Socks Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("SocksWindow", "Install"))
        self.uninstallclient.setText(_translate("SocksWindow", "UnInstall Socks"))
        self.updateclient.setText(_translate("SocksWindow", "Update Socks"))
        self.deleteclient.setText(_translate("SocksWindow", "Delete Socks"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("SocksWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    SocksWindow = QtWidgets.QMainWindow()
    ui = Ui_SocksWindow()
    ui.setupUi(SocksWindow)
    SocksWindow.show()
    sys.exit(app.exec_()) 
