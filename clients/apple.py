...
def updateclient():
    os.system('echo "Lets get Apple updated for you." ; cd ~/apple-blockchain ; . ./activate ; apple stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:26660,26661,26668,26660,26666) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.apple ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.apple -t ~/plow/old-config/ ; rm -f --recursive -d ~/apple-blockchain ; git clone https://github.com/Apple-Network/apple-blockchain.git ; cd ~/apple-blockchain ; sh install.sh ; . ./activate ; apple init ; cd ~/plow/old-config/.apple/mainnet ; mv db wallet -t ~/.apple/mainnet ; cd ~/apple-blockchain ; apple start farmer ; echo "Apple has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.apple/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Apple uninstalled for you." ; cd ~/apple-blockchain ; . ./activate ; apple stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.apple ; mv ~/.apple -t ~/plow/old-config/ ; rm -f --recursive -d ~/apple-blockchain ; echo "Apple has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Apple deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.apple ; mv ~/.apple -t ~/plow/old-config/ ; rm -f --recursive -d ~/apple-blockchain ; echo "Apple has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Apple Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/apple-blockchain ; . ./activate ; apple keys show')
    
def mnemonic():
    os.system('echo "Getting Active Apple Mnemonic Key..." ; cd ~/apple-blockchain ; . ./activate ; apple keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Apple Mnemonic Key..." ; cd ~/apple-blockchain ; . ./activate ; apple generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Apple Keys..." ; cd ~/apple-blockchain ; . ./activate ; apple keys add')
	
def genkey():
    os.system('echo "Generating New Apple Mnemonic key..." ; cd ~/apple-blockchain ; . ./activate ; apple keys generate')

def stop():
    os.system('echo "Stopping Apple..." ; cd ~/apple-blockchain ; . ./activate ; apple stop all')
	
def version():
    os.system('echo "Apple Verion Number..." ; cd ~/apple-blockchain ; . ./activate ; apple version')

def startcli():
    os.system('echo "Starting Apple..." ; cd ~/apple-blockchain ; . ./activate ; apple stop all ; deactivate ; cd ~/ ; cd ~/apple-blockchain ; . ./activate ; apple start farmer')

def chain():
    os.system('echo "Getting The State Of Apple Blockchain..." ; cd ~/apple-blockchain ; . ./activate ; apple show -s')

def connections():
    os.system('echo "Getting Apple Peer Connections..." ; cd ~/apple-blockchain ; . ./activate ; apple show -c')

def wallet():
    os.system('echo "Apple Wallet Is Loading..." ; cd ~/apple-blockchain ; . ./activate ; apple wallet show')

def getaddress():
    os.system('echo "Getting Apple Address..." ; cd ~/apple-blockchain ; . ./activate ; apple wallet get_address')

def gettransactions():
    os.system('echo "Getting Apple Transactions..." ; cd ~/apple-blockchain ; . ./activate ; apple wallet get_transactions')
	
def summary():
    os.system('echo "Apple Farm Summary Loading..." ; cd ~/apple-blockchain ; . ./activate ; apple farm summary')
	
def challenges():
    os.system('echo "Apple Challenges Loading..." ; cd ~/apple-blockchain ; . ./activate ; apple farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Apple Config File..." ; xdg-open ~/.apple/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Apple Log File..." ; xdg-open ~/.apple/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Apple-GUI..." ; cd ~/apple-blockchain ; . ./activate ; cd apple-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Apple-GUI installed for you." ; cd ~/apple-blockchain ; . ./activate ; sh install-gui.sh ; cd apple-blockchian-gui ; npm run electron')
 
def closedaemonport():
    os.system('echo "Closing Apple Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:26660) ; echo "Process IDs on Daemon Port 26660 Closed"')             

def closefarmerport():
    os.system('echo "Closing Apple Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:26660) ; echo "Process IDs on Farmer Port 26660 Closed"')

def closeharvesterport():
    os.system('echo "Closing Apple Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:26661) ; echo "Process IDs on Harvester Port 26661 Closed"')

def closefullnodeport():
    os.system('echo "Closing Apple Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:26666) ; echo "Process IDs on Full Node Port 26666 Closed"')

def closewalletport():
    os.system('echo "Closing All Apple Ports..." ; echo "Closing Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:26668) & Wallet Port 26668 had no PIDs active. & echo "Process IDs on Wallet Port 26668 Closed"')

def listports():
    os.system('echo "List of All Apple Process IDs for Ports, Daemon 26660, Harvester 26661, Wallet 26668, Farmer 26660, Full Node 26666." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:26660,26661,26668,26660,26666')

def closeallport():
    os.system('echo "Closing All Apple Ports..." ; sudo kill -9 $(sudo lsof -t -i:26660,26661,26668,26660,26666) ; echo "All Process IDs on Ports, Daemon 26660, Harvester 26661, Wallet 26668, Farmer 26660, Full Node 26666, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Apple Folder" ; cd ~/apple-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_AppleWindow(object):
    def setupUi(self, AppleWindow):
        AppleWindow.setObjectName("AppleWindow")
        AppleWindow.resize(483, 320)
...
#TAB LAYOUT
    ...
    def retranslateUi(self, AppleWindow):
        ...
        AppleWindow.setWindowTitle(_translate("AppleWindow", "Apple"))
        self.connections.setText(_translate("AppleWindow", "Connections"))
        self.summary.setText(_translate("AppleWindow", "Farm Summary"))
        self.config.setText(_translate("AppleWindow", "Config"))
        self.wallet.setText(_translate("AppleWindow", "Show Apple Wallet"))
        self.chain.setText(_translate("AppleWindow", "State Of Apple"))
        self.startcli.setText(_translate("AppleWindow", "Start-CLI"))
        self.startgui.setText(_translate("AppleWindow", "Start-GUI"))
        self.log.setText(_translate("AppleWindow", "Log"))
        self.challenges.setText(_translate("AppleWindow", "Challenges"))
        self.stop.setText(_translate("AppleWindow", "Stop"))
        self.terminal.setText(_translate("AppleWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("AppleWindow", "Dashboard"))
        self.genkey.setText(_translate("AppleWindow", "Generate Key"))
        self.gettransactions.setText(_translate("AppleWindow", "Get Transactions"))
        self.getaddress.setText(_translate("AppleWindow", "Get Address"))
        self.mnemonic.setText(_translate("AppleWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("AppleWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("AppleWindow", "Add Key"))
        self.keysshow.setText(_translate("AppleWindow", "Apple Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("AppleWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("AppleWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("AppleWindow", "Close Full-Node 26666"))
        self.listports.setText(_translate("AppleWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("AppleWindow", "Close Farmer 26660"))
        self.closewalletport.setText(_translate("AppleWindow", "Close Wallet 26668"))
        self.closeharvesterport.setText(_translate("AppleWindow", "Close Harvester 26661"))
        self.closedaemonport.setText(_translate("AppleWindow", "Close Daemon 26660"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("AppleWindow", "Ports"))
        self.installcli.setText(_translate("AppleWindow", "Install CLI"))
        self.installgui.setText(_translate("AppleWindow", "Install GUI"))
        self.version.setText(_translate("AppleWindow", "Apple Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("AppleWindow", "Install"))
        self.uninstallclient.setText(_translate("AppleWindow", "UnInstall Apple"))
        self.updateclient.setText(_translate("AppleWindow", "Update Apple"))
        self.deleteclient.setText(_translate("AppleWindow", "Delete Apple"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("AppleWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    AppleWindow = QtWidgets.QMainWindow()
    ui = Ui_AppleWindow()
    ui.setupUi(AppleWindow)
    AppleWindow.show()
    sys.exit(app.exec_()) 
