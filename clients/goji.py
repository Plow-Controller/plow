...
def updateclient():
    os.system('echo "Lets get Goji updated for you." ; cd ~/goji-blockchain ; . ./activate ; goji stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:57500,7448,7449,7447,7444) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.goji-blockchain ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.goji-blockchain -t ~/plow/old-config/ ; rm -f --recursive -d ~/goji-blockchain ; git clone https://github.com/GetGoji/goji-blockchain.git ; cd ~/goji-blockchain ; sh install.sh ; . ./activate ; goji init ; cd ~/plow/old-config/.goji-blockchain/mainnet ; mv db wallet -t ~/.goji-blockchain/mainnet ; cd ~/goji-blockchain ; goji start farmer ; echo "Goji has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.goji-blockchain/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Goji uninstalled for you." ; cd ~/goji-blockchain ; . ./activate ; goji stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.goji-blockchain ; mv ~/.goji-blockchain -t ~/plow/old-config/ ; rm -f --recursive -d ~/goji-blockchain ; echo "Goji has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Goji deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.goji-blockchain ; mv ~/.goji-blockchain -t ~/plow/old-config/ ; rm -f --recursive -d ~/goji-blockchain ; echo "Goji has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Goji Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/goji-blockchain ; . ./activate ; goji keys show')
    
def mnemonic():
    os.system('echo "Getting Active Goji Mnemonic Key..." ; cd ~/goji-blockchain ; . ./activate ; goji keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Goji Mnemonic Key..." ; cd ~/goji-blockchain ; . ./activate ; goji generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Please Wait For Prompt To Add Existing Goji Keys..." ; cd ~/goji-blockchain ; . ./activate ; goji keys add')
	
def genkey():
    os.system('echo "Generating New Goji Mnemonic key..." ; cd ~/goji-blockchain ; . ./activate ; goji keys generate')

def stop():
    os.system('echo "Stopping Goji..." ; cd ~/goji-blockchain ; . ./activate ; goji stop all')
	
def version():
    os.system('echo "Goji Verion Number..." ; cd ~/goji-blockchain ; . ./activate ; goji version')

def startcli():
    os.system('echo "Starting Goji..." ; cd ~/goji-blockchain ; . ./activate ; goji stop all ; deactivate ; cd ~/ ; cd ~/goji-blockchain ; . ./activate ; goji start farmer')

def chain():
    os.system('echo "Getting The State Of Goji Blockchain..." ; cd ~/goji-blockchain ; . ./activate ; goji show -s')

def connections():
    os.system('echo "Getting Goji Peer Connections..." ; cd ~/goji-blockchain ; . ./activate ; goji show -c')

def wallet():
    os.system('echo "Goji Wallet Is Loading..." ; cd ~/goji-blockchain ; . ./activate ; goji wallet show')

def getaddress():
    os.system('echo "Getting Goji Address..." ; cd ~/goji-blockchain ; . ./activate ; goji wallet get_address')

def gettransactions():
    os.system('echo "Getting Goji Transactions..." ; cd ~/goji-blockchain ; . ./activate ; goji wallet get_transactions')
	
def summary():
    os.system('echo "Goji Farm Summary Loading..." ; cd ~/goji-blockchain ; . ./activate ; goji farm summary')
	
def challenges():
    os.system('echo "Goji Challenges Loading..." ; cd ~/goji-blockchain ; . ./activate ; goji farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Goji Config File..." ; xdg-open ~/.goji-blockchain/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Goji Log File..." ; xdg-open ~/.goji-blockchain/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Goji-GUI..." ; cd ~/goji-blockchain ; . ./activate ; cd goji-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Goji-GUI installed for you." ; cd ~/goji-blockchain ; . ./activate ; sh install-gui.sh ; cd goji-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Goji Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:57500) ; echo "Process IDs On Daemon Port 57500 Closed"')             

def closefarmerport():
    os.system('echo "Closing Goji Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:7447) ; echo "Process IDs On Farmer Port 7447 Closed"')

def closeharvesterport():
    os.system('echo "Closing Goji Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:7448) ; echo "Process IDs On Harvester Port 7448 Closed"')

def closefullnodeport():
    os.system('echo "Closing Goji Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:7444) ; echo "Process IDs On Full Node Port 7444 Closed"')

def closewalletport():
    os.system('echo "Closing Goji Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:7449) ; echo "Process IDs on Wallet Port 7449 Closed"')

def listports():
    os.system('echo "List of All Goji Process IDs for Ports, Daemon 57500, Harvester 7448, Wallet 7449, Farmer 7447, Full Node 7444." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:57500,7448,7449,7447,7444')

def closeallport():
    os.system('echo "Closing All Goji Ports..." ; sudo kill -9 $(sudo lsof -t -i:57500,7448,7449,7447,7444) ; echo "All Process IDs on Ports, Daemon 57500, Harvester 7448, Wallet 7449, Farmer 7447, Full Node 7444, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Goji Folder" ; cd ~/goji-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_GojiWindow(object):
    def setupUi(self, GojiWindow):
        GojiWindow.setObjectName("GojiWindow")
        GojiWindow.resize(483, 320)
...
#START MAIN WINDOW
        GojiWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        GojiWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(GojiWindow)
...
#TAB LAYOUT
        ...
        GojiWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(GojiWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(GojiWindow)

    def retranslateUi(self, GojiWindow):
        _translate = QtCore.QCoreApplication.translate
        GojiWindow.setWindowTitle(_translate("GojiWindow", "Goji"))
        self.connections.setText(_translate("GojiWindow", "Connections"))
        self.summary.setText(_translate("GojiWindow", "Farm Summary"))
        self.config.setText(_translate("GojiWindow", "Config"))
        self.wallet.setText(_translate("GojiWindow", "Show Goji Wallet"))
        self.chain.setText(_translate("GojiWindow", "State Of Goji"))
        self.startcli.setText(_translate("GojiWindow", "Start-CLI"))
        self.startgui.setText(_translate("GojiWindow", "Start-GUI"))
        self.log.setText(_translate("GojiWindow", "Log"))
        self.challenges.setText(_translate("GojiWindow", "Challenges"))
        self.stop.setText(_translate("GojiWindow", "Stop"))
        self.terminal.setText(_translate("GojiWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("GojiWindow", "Dashboard"))
        self.genkey.setText(_translate("GojiWindow", "Generate Key"))
        self.gettransactions.setText(_translate("GojiWindow", "Get Transactions"))
        self.getaddress.setText(_translate("GojiWindow", "Get Address"))
        self.mnemonic.setText(_translate("GojiWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("GojiWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("GojiWindow", "Add Key"))
        self.keysshow.setText(_translate("GojiWindow", "Goji Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("GojiWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("GojiWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("GojiWindow", "Close Full-Node 7444"))
        self.listports.setText(_translate("GojiWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("GojiWindow", "Close Farmer 7447"))
        self.closewalletport.setText(_translate("GojiWindow", "Close Wallet 7449"))
        self.closeharvesterport.setText(_translate("GojiWindow", "Close Harvester 7448"))
        self.closedaemonport.setText(_translate("GojiWindow", "Close Daemon 57500"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("GojiWindow", "Ports"))
        self.installcli.setText(_translate("GojiWindow", "Install CLI"))
        self.installgui.setText(_translate("GojiWindow", "Install GUI"))
        self.version.setText(_translate("GojiWindow", "Goji Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("GojiWindow", "Install"))
        self.uninstallclient.setText(_translate("GojiWindow", "UnInstall Goji"))
        self.updateclient.setText(_translate("GojiWindow", "Update Goji"))
        self.deleteclient.setText(_translate("GojiWindow", "Delete Goji"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("GojiWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    GojiWindow = QtWidgets.QMainWindow()
    ui = Ui_GojiWindow()
    ui.setupUi(GojiWindow)
    GojiWindow.show()
    sys.exit(app.exec_()) 
