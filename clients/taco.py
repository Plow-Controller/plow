...
def updateclient():
    os.system('echo "Lets get Taco updated for you." ; cd ~/taco-blockchain ; . ./activate ; taco stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:44476,18624,18625,18623,18620) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.taco ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.taco -t ~/plow/old-config/ ; rm -f --recursive -d ~/taco-blockchain ; git clone https://github.com/Taco-Network/taco-blockchain.git ; cd ~/taco-blockchain ; sh install.sh ; . ./activate ; taco init ; cd ~/plow/old-config/.taco/mainnet ; mv db wallet -t ~/.taco/mainnet ; cd ~/taco-blockchain ; taco start farmer ; echo "Taco has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.taco/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Taco uninstalled for you." ; cd ~/taco-blockchain ; . ./activate ; taco stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.taco ; mv ~/.taco -t ~/plow/old-config/ ; rm -f --recursive -d ~/taco-blockchain ; echo "Taco has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Taco deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.taco ; mv ~/.taco -t ~/plow/old-config/ ; rm -f --recursive -d ~/taco-blockchain ; echo "Taco has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Taco Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/taco-blockchain ; . ./activate ; taco keys show')
    
def mnemonic():
    os.system('echo "Getting Active Taco Mnemonic Key..." ; cd ~/taco-blockchain ; . ./activate ; taco keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Taco Mnemonic Key..." ; cd ~/taco-blockchain ; . ./activate ; taco generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Taco Keys..." ; cd ~/taco-blockchain ; . ./activate ; taco keys add')
	
def genkey():
    os.system('echo "Generating New Taco Mnemonic key..." ; cd ~/taco-blockchain ; . ./activate ; taco keys generate')

def stop():
    os.system('echo "Stopping Taco..." ; cd ~/taco-blockchain ; . ./activate ; taco stop all')
	
def version():
    os.system('echo "Taco Verion Number..." ; cd ~/taco-blockchain ; . ./activate ; taco version')

def startcli():
    os.system('echo "Starting Taco..." ; cd ~/taco-blockchain ; . ./activate ; taco stop all ; deactivate ; cd ~/ ; cd ~/taco-blockchain ; . ./activate ; taco start farmer')

def chain():
    os.system('echo "Getting The State Of Taco Blockchain..." ; cd ~/taco-blockchain ; . ./activate ; taco show -s')

def connections():
    os.system('echo "Getting Taco Peer Connections..." ; cd ~/taco-blockchain ; . ./activate ; taco show -c')

def wallet():
    os.system('echo "Taco Wallet Is Loading..." ; cd ~/taco-blockchain ; . ./activate ; taco wallet show')

def getaddress():
    os.system('echo "Getting Taco Address..." ; cd ~/taco-blockchain ; . ./activate ; taco wallet get_address')

def gettransactions():
    os.system('echo "Getting Taco Transactions..." ; cd ~/taco-blockchain ; . ./activate ; taco wallet get_transactions')
	
def summary():
    os.system('echo "Taco Farm Summary Loading..." ; cd ~/taco-blockchain ; . ./activate ; taco farm summary')
	
def challenges():
    os.system('echo "Taco Challenges Loading..." ; cd ~/taco-blockchain ; . ./activate ; taco farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Taco Config File..." ; xdg-open ~/.taco/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Taco Log File..." ; xdg-open ~/.taco/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Taco-GUI..." ; cd ~/taco-blockchain ; . ./activate ; cd taco-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Taco-GUI installed for you." ; cd ~/taco-blockchain ; . ./activate ; sh install-gui.sh ; cd taco-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Taco Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:44476) ; echo "Process IDs On Daemon Port 44476 Closed"')             

def closefarmerport():
    os.system('echo "Closing Taco Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:18623) ; echo "Process IDs On Farmer Port 18623 Closed"')

def closeharvesterport():
    os.system('echo "Closing Taco Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:18624) ; echo "Process IDs On Harvester Port 18624 Closed"')

def closefullnodeport():
    os.system('echo "Closing Taco Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:18620) ; echo "Process IDs On Full Node Port 18620 Closed"')

def closewalletport():
    os.system('echo "Closing Taco Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:18625) ; echo "Process IDs on Wallet Port 18625 Closed"')

def listports():
    os.system('echo "List of All Taco Process IDs for Ports, Daemon 44476, Harvester 18624, Wallet 18625, Farmer 18623, Full Node 18620." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:44476,18624,18625,18623,18620')

def closeallport():
    os.system('echo "Closing All Taco Ports..." ; sudo kill -9 $(sudo lsof -t -i:44476,18624,18625,18623,18620) ; echo "All Process IDs on Ports, Daemon 44476, Harvester 18624, Wallet 18625, Farmer 18623, Full Node 18620, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Taco Folder" ; cd ~/taco-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_TacoWindow(object):
    def setupUi(self, TacoWindow):
        TacoWindow.setObjectName("TacoWindow")
        TacoWindow.resize(483, 320)
...
#START MAIN WINDOW
        TacoWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        TacoWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(TacoWindow)
...
#TAB LAYOUT
        ...
        TacoWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(TacoWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(TacoWindow)

    def retranslateUi(self, TacoWindow):
        _translate = QtCore.QCoreApplication.translate
        TacoWindow.setWindowTitle(_translate("TacoWindow", "Taco"))
        self.connections.setText(_translate("TacoWindow", "Connections"))
        self.summary.setText(_translate("TacoWindow", "Farm Summary"))
        self.config.setText(_translate("TacoWindow", "Config"))
        self.wallet.setText(_translate("TacoWindow", "Show Taco Wallet"))
        self.chain.setText(_translate("TacoWindow", "State Of Taco"))
        self.startcli.setText(_translate("TacoWindow", "Start-CLI"))
        self.startgui.setText(_translate("TacoWindow", "Start-GUI"))
        self.log.setText(_translate("TacoWindow", "Log"))
        self.challenges.setText(_translate("TacoWindow", "Challenges"))
        self.stop.setText(_translate("TacoWindow", "Stop"))
        self.terminal.setText(_translate("TacoWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("TacoWindow", "Dashboard"))
        self.genkey.setText(_translate("TacoWindow", "Generate Key"))
        self.gettransactions.setText(_translate("TacoWindow", "Get Transactions"))
        self.getaddress.setText(_translate("TacoWindow", "Get Address"))
        self.mnemonic.setText(_translate("TacoWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("TacoWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("TacoWindow", "Add Key"))
        self.keysshow.setText(_translate("TacoWindow", "Taco Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("TacoWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("TacoWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("TacoWindow", "Close Full-Node 18620"))
        self.listports.setText(_translate("TacoWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("TacoWindow", "Close Farmer 18623"))
        self.closewalletport.setText(_translate("TacoWindow", "Close Wallet 18625"))
        self.closeharvesterport.setText(_translate("TacoWindow", "Close Harvester 18624"))
        self.closedaemonport.setText(_translate("TacoWindow", "Close Daemon 44476"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("TacoWindow", "Ports"))
        self.installcli.setText(_translate("TacoWindow", "Install CLI"))
        self.installgui.setText(_translate("TacoWindow", "Install GUI"))
        self.version.setText(_translate("TacoWindow", "Taco Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("TacoWindow", "Install"))
        self.uninstallclient.setText(_translate("TacoWindow", "UnInstall Taco"))
        self.updateclient.setText(_translate("TacoWindow", "Update Taco"))
        self.deleteclient.setText(_translate("TacoWindow", "Delete Taco"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("TacoWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    TacoWindow = QtWidgets.QMainWindow()
    ui = Ui_TacoWindow()
    ui.setupUi(TacoWindow)
    TacoWindow.show()
    sys.exit(app.exec_()) 
