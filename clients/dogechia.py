...
def updateclient():
    os.system('echo "Lets get Dogechia updated for you." ; cd ~/doge-chia ; . ./activate ; dogechia stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:56669,6869,6883,6969,42069) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.dogechia ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.dogechia -t ~/plow/old-config/ ; rm -f --recursive -d ~/doge-chia ; git clone https://github.com/DogeChia/doge-chia.git ; cd ~/doge-chia ; sh install.sh ; . ./activate ; dogechia init ; cd ~/plow/old-config/.dogechia/mainnet ; mv db wallet -t ~/.dogechia/mainnet ; cd ~/doge-chia ; dogechia start farmer ; echo "Dogechia has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.dogechia/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Dogechia uninstalled for you." ; cd ~/doge-chia ; . ./activate ; dogechia stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.dogechia ; mv ~/.dogechia -t ~/plow/old-config/ ; rm -f --recursive -d ~/doge-chia ; echo "Dogechia has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Dogechia deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.dogechia ; mv ~/.dogechia -t ~/plow/old-config/ ; rm -f --recursive -d ~/doge-chia ; echo "Dogechia has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Dogechia Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/doge-chia ; . ./activate ; dogechia keys show')
    
def mnemonic():
    os.system('echo "Getting Active Dogechia Mnemonic Key..." ; cd ~/doge-chia ; . ./activate ; dogechia keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Dogechia Mnemonic Key..." ; cd ~/doge-chia ; . ./activate ; dogechia generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Dogechia Keys..." ; cd ~/doge-chia ; . ./activate ; dogechia keys add')
	
def genkey():
    os.system('echo "Generating New Dogechia Mnemonic key..." ; cd ~/doge-chia ; . ./activate ; dogechia keys generate')

def stop():
    os.system('echo "Stopping Dogechia..." ; cd ~/doge-chia ; . ./activate ; dogechia stop all')
	
def version():
    os.system('echo "Dogechia Verion Number..." ; cd ~/doge-chia ; . ./activate ; dogechia version')

def startcli():
    os.system('echo "Starting Dogechia..." ; cd ~/doge-chia ; . ./activate ; dogechia stop all ; deactivate ; cd ~/ ; cd ~/doge-chia ; . ./activate ; dogechia start farmer')

def chain():
    os.system('echo "Getting The State Of Dogechia Blockchain..." ; cd ~/doge-chia ; . ./activate ; dogechia show -s')

def connections():
    os.system('echo "Getting Dogechia Peer Connections..." ; cd ~/doge-chia ; . ./activate ; dogechia show -c')

def wallet():
    os.system('echo "Dogechia Wallet Is Loading..." ; cd ~/doge-chia ; . ./activate ; dogechia wallet show')

def getaddress():
    os.system('echo "Getting Dogechia Address..." ; cd ~/doge-chia ; . ./activate ; dogechia wallet get_address')

def gettransactions():
    os.system('echo "Getting Dogechia Transactions..." ; cd ~/doge-chia ; . ./activate ; dogechia wallet get_transactions')
	
def summary():
    os.system('echo "Dogechia Farm Summary Loading..." ; cd ~/doge-chia ; . ./activate ; dogechia farm summary')
	
def challenges():
    os.system('echo "Dogechia Challenges Loading..." ; cd ~/doge-chia ; . ./activate ; dogechia farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Dogechia Config File..." ; xdg-open ~/.dogechia/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Dogechia Log File..." ; xdg-open ~/.dogechia/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Dogechia-GUI..." ; cd ~/doge-chia ; . ./activate ; cd dogechia-blockchain-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Dogechia-GUI installed for you." ; cd ~/doge-chia ; . ./activate ; sh install-gui.sh ; cd dogechia-blockchain-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Dogechia Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:56669) ; echo "Process IDs On Daemon Port 56669 Closed"')             

def closefarmerport():
    os.system('echo "Closing Dogechia Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:6969) ; echo "Process IDs On Farmer Port 6969 Closed"')

def closeharvesterport():
    os.system('echo "Closing Dogechia Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:6869) ; echo "Process IDs On Harvester Port 6869 Closed"')

def closefullnodeport():
    os.system('echo "Closing Dogechia Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:42069) ; echo "Process IDs On Full Node Port 42069 Closed"')

def closewalletport():
    os.system('echo "Closing Dogechia Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:6883) ; echo "Process IDs on Wallet Port 6883 Closed"')

def listports():
    os.system('echo "List of All Dogechia Process IDs for Ports, Daemon 56669, Harvester 6869, Wallet 6883, Farmer 6969, Full Node 42069." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:56669,6869,6883,6969,42069')

def closeallport():
    os.system('echo "Closing All Dogechia Ports..." ; sudo kill -9 $(sudo lsof -t -i:56669,6869,6883,6969,42069) ; echo "All Process IDs on Ports, Daemon 56669, Harvester 6869, Wallet 6883, Farmer 6969, Full Node 42069, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Dogechia Folder" ; cd ~/doge-chia ; x-terminal-emulator -- ', shell =True)


class Ui_DogechiaWindow(object):
    def setupUi(self, DogechiaWindow):
        DogechiaWindow.setObjectName("DogechiaWindow")
        DogechiaWindow.resize(483, 320)
...
#START MAIN WINDOW
        DogechiaWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        DogechiaWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(DogechiaWindow)
...
#TAB LAYOUT
        ...
        DogechiaWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(DogechiaWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(DogechiaWindow)

    def retranslateUi(self, DogechiaWindow):
        _translate = QtCore.QCoreApplication.translate
        DogechiaWindow.setWindowTitle(_translate("DogechiaWindow", "Dogechia"))
        self.connections.setText(_translate("DogechiaWindow", "Connections"))
        self.summary.setText(_translate("DogechiaWindow", "Farm Summary"))
        self.config.setText(_translate("DogechiaWindow", "Config"))
        self.wallet.setText(_translate("DogechiaWindow", "Show Dogechia Wallet"))
        self.chain.setText(_translate("DogechiaWindow", "State Of Dogechia"))
        self.startcli.setText(_translate("DogechiaWindow", "Start-CLI"))
        self.startgui.setText(_translate("DogechiaWindow", "Start-GUI"))
        self.log.setText(_translate("DogechiaWindow", "Log"))
        self.challenges.setText(_translate("DogechiaWindow", "Challenges"))
        self.stop.setText(_translate("DogechiaWindow", "Stop"))
        self.terminal.setText(_translate("DogechiaWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("DogechiaWindow", "Dashboard"))
        self.genkey.setText(_translate("DogechiaWindow", "Generate Key"))
        self.gettransactions.setText(_translate("DogechiaWindow", "Get Transactions"))
        self.getaddress.setText(_translate("DogechiaWindow", "Get Address"))
        self.mnemonic.setText(_translate("DogechiaWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("DogechiaWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("DogechiaWindow", "Add Key"))
        self.keysshow.setText(_translate("DogechiaWindow", "Dogechia Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("DogechiaWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("DogechiaWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("DogechiaWindow", "Close Full-Node 42069"))
        self.listports.setText(_translate("DogechiaWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("DogechiaWindow", "Close Farmer 6969"))
        self.closewalletport.setText(_translate("DogechiaWindow", "Close Wallet 6883"))
        self.closeharvesterport.setText(_translate("DogechiaWindow", "Close Harvester 6869"))
        self.closedaemonport.setText(_translate("DogechiaWindow", "Close Daemon 56669"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("DogechiaWindow", "Ports"))
        self.installcli.setText(_translate("DogechiaWindow", "Install CLI"))
        self.installgui.setText(_translate("DogechiaWindow", "Install GUI"))
        self.version.setText(_translate("DogechiaWindow", "Dogechia Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("DogechiaWindow", "Install"))
        self.uninstallclient.setText(_translate("DogechiaWindow", "UnInstall Dogechia"))
        self.updateclient.setText(_translate("DogechiaWindow", "Update Dogechia"))
        self.deleteclient.setText(_translate("DogechiaWindow", "Delete Dogechia"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("DogechiaWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    DogechiaWindow = QtWidgets.QMainWindow()
    ui = Ui_DogechiaWindow()
    ui.setupUi(DogechiaWindow)
    DogechiaWindow.show()
    sys.exit(app.exec_()) 
