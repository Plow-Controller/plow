...
def updateclient():
    os.system('echo "Lets get Silicoin updated for you." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:56401,10448,10449,10447,10444) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.silicoin ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.silicoin -t ~/plow/old-config/ ; rm -f --recursive -d ~/silicoin-blockchain ; git clone https://github.com/silicoin-network/silicoin-blockchain.git ; cd ~/silicoin-blockchain ; sh install.sh ; . ./activate ; silicoin init ; cd ~/plow/old-config/.silicoin/mainnet ; mv db wallet -t ~/.silicoin/mainnet ; cd ~/silicoin-blockchain ; silicoin start farmer ; echo "Silicoin has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.silicoin/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Silicoin uninstalled for you." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.silicoin ; mv ~/.silicoin -t ~/plow/old-config/ ; rm -f --recursive -d ~/silicoin-blockchain ; echo "Silicoin has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Silicoin deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.silicoin ; mv ~/.silicoin -t ~/plow/old-config/ ; rm -f --recursive -d ~/silicoin-blockchain ; echo "Silicoin has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Silicoin Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin keys show')
    
def mnemonic():
    os.system('echo "Getting Active Silicoin Mnemonic Key..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Silicoin Mnemonic Key..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Silicoin Keys..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin keys add')
	
def genkey():
    os.system('echo "Generating New Silicoin Mnemonic key..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin keys generate')

def stop():
    os.system('echo "Stopping Silicoin..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin stop all')
	
def version():
    os.system('echo "Silicoin Verion Number..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin version')

def startcli():
    os.system('echo "Starting Silicoin..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin stop all ; deactivate ; cd ~/ ; cd ~/silicoin-blockchain ; . ./activate ; silicoin start farmer')

def chain():
    os.system('echo "Getting The State Of Silicoin Blockchain..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin show -s')

def connections():
    os.system('echo "Getting Silicoin Peer Connections..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin show -c')

def wallet():
    os.system('echo "Silicoin Wallet Is Loading..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin wallet show')

def getaddress():
    os.system('echo "Getting Silicoin Address..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin wallet get_address')

def gettransactions():
    os.system('echo "Getting Silicoin Transactions..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin wallet get_transactions')
	
def summary():
    os.system('echo "Silicoin Farm Summary Loading..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin farm summary')
	
def challenges():
    os.system('echo "Silicoin Challenges Loading..." ; cd ~/silicoin-blockchain ; . ./activate ; silicoin farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Silicoin Config File..." ; xdg-open ~/.silicoin/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Silicoin Log File..." ; xdg-open ~/.silicoin/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Silicoin-GUI..." ; cd ~/silicoin-blockchain ; . ./activate ; cd silicoin-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Silicoin-GUI installed for you." ; cd ~/silicoin-blockchain ; . ./activate ; sh install-gui.sh ; cd silicoin-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Silicoin Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:56401) ; echo "Process IDs On Daemon Port 56401 Closed"')             

def closefarmerport():
    os.system('echo "Closing Silicoin Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:10447) ; echo "Process IDs On Farmer Port 10447 Closed"')

def closeharvesterport():
    os.system('echo "Closing Silicoin Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:10448) ; echo "Process IDs On Harvester Port 10448 Closed"')

def closefullnodeport():
    os.system('echo "Closing Silicoin Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:10444) ; echo "Process IDs On Full Node Port 10444 Closed"')

def closewalletport():
    os.system('echo "Closing Silicoin Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:10449) ; echo "Process IDs on Wallet Port 10449 Closed"')

def listports():
    os.system('echo "List of All Silicoin Process IDs for Ports, Daemon 56401, Harvester 10448, Wallet 10449, Farmer 10447, Full Node 10444." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:56401,10448,10449,10447,10444')

def closeallport():
    os.system('echo "Closing All Silicoin Ports..." ; sudo kill -9 $(sudo lsof -t -i:56401,10448,10449,10447,10444) ; echo "All Process IDs on Ports, Daemon 56401, Harvester 10448, Wallet 10449, Farmer 10447, Full Node 10444, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Silicoin Folder" ; cd ~/silicoin-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_SilicoinWindow(object):
    def setupUi(self, SilicoinWindow):
        SilicoinWindow.setObjectName("SilicoinWindow")
        SilicoinWindow.resize(483, 320)
...
#START MAIN WINDOW
        SilicoinWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SilicoinWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(SilicoinWindow)
...
#TAB LAYOUT
        ...
        SilicoinWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(SilicoinWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(SilicoinWindow)

    def retranslateUi(self, SilicoinWindow):
        _translate = QtCore.QCoreApplication.translate
        SilicoinWindow.setWindowTitle(_translate("SilicoinWindow", "Silicoin"))
        self.connections.setText(_translate("SilicoinWindow", "Connections"))
        self.summary.setText(_translate("SilicoinWindow", "Farm Summary"))
        self.config.setText(_translate("SilicoinWindow", "Config"))
        self.wallet.setText(_translate("SilicoinWindow", "Show Silicoin Wallet"))
        self.chain.setText(_translate("SilicoinWindow", "State Of Silicoin"))
        self.startcli.setText(_translate("SilicoinWindow", "Start-CLI"))
        self.startgui.setText(_translate("SilicoinWindow", "Start-GUI"))
        self.log.setText(_translate("SilicoinWindow", "Log"))
        self.challenges.setText(_translate("SilicoinWindow", "Challenges"))
        self.stop.setText(_translate("SilicoinWindow", "Stop"))
        self.terminal.setText(_translate("SilicoinWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("SilicoinWindow", "Dashboard"))
        self.genkey.setText(_translate("SilicoinWindow", "Generate Key"))
        self.gettransactions.setText(_translate("SilicoinWindow", "Get Transactions"))
        self.getaddress.setText(_translate("SilicoinWindow", "Get Address"))
        self.mnemonic.setText(_translate("SilicoinWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("SilicoinWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("SilicoinWindow", "Add Key"))
        self.keysshow.setText(_translate("SilicoinWindow", "Silicoin Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("SilicoinWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("SilicoinWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("SilicoinWindow", "Close Full-Node 10444"))
        self.listports.setText(_translate("SilicoinWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("SilicoinWindow", "Close Farmer 10447"))
        self.closewalletport.setText(_translate("SilicoinWindow", "Close Wallet 10449"))
        self.closeharvesterport.setText(_translate("SilicoinWindow", "Close Harvester 10448"))
        self.closedaemonport.setText(_translate("SilicoinWindow", "Close Daemon 56401"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("SilicoinWindow", "Ports"))
        self.installcli.setText(_translate("SilicoinWindow", "Install CLI"))
        self.installgui.setText(_translate("SilicoinWindow", "Install GUI"))
        self.version.setText(_translate("SilicoinWindow", "Silicoin Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("SilicoinWindow", "Install"))
        self.uninstallclient.setText(_translate("SilicoinWindow", "UnInstall Silicoin"))
        self.updateclient.setText(_translate("SilicoinWindow", "Update Silicoin"))
        self.deleteclient.setText(_translate("SilicoinWindow", "Delete Silicoin"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("SilicoinWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    SilicoinWindow = QtWidgets.QMainWindow()
    ui = Ui_SilicoinWindow()
    ui.setupUi(SilicoinWindow)
    SilicoinWindow.show()
    sys.exit(app.exec_()) 
