...
def updateclient():
    os.system('echo "Lets get Equality updated for you." ; cd ~/equality-blockchain ; . ./activate ; equality stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:55421,9884,9883,9885,9888) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.equality ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.equality -t ~/plow/old-config/ ; rm -f --recursive -d ~/equality-blockchain ; git clone https://github.com/Equality-Network/equality-blockchain.git ; cd ~/equality-blockchain ; sh install.sh ; . ./activate ; equality init ; cd ~/plow/old-config/.equality/mainnet ; mv db wallet -t ~/.equality/mainnet ; cd ~/equality-blockchain ; equality start farmer ; echo "Equality has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.equality/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Equality uninstalled for you." ; cd ~/equality-blockchain ; . ./activate ; equality stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.equality ; mv ~/.equality -t ~/plow/old-config/ ; rm -f --recursive -d ~/equality-blockchain ; echo "Equality has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Equality deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.equality ; mv ~/.equality -t ~/plow/old-config/ ; rm -f --recursive -d ~/equality-blockchain ; echo "Equality has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Equality Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/equality-blockchain ; . ./activate ; equality keys show')
    
def mnemonic():
    os.system('echo "Getting Active Equality Mnemonic Key..." ; cd ~/equality-blockchain ; . ./activate ; equality keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Equality Mnemonic Key..." ; cd ~/equality-blockchain ; . ./activate ; equality generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Equality Keys..." ; cd ~/equality-blockchain ; . ./activate ; equality keys add')
	
def genkey():
    os.system('echo "Generating New Equality Mnemonic key..." ; cd ~/equality-blockchain ; . ./activate ; equality keys generate')

def stop():
    os.system('echo "Stopping Equality..." ; cd ~/equality-blockchain ; . ./activate ; equality stop all')
	
def version():
    os.system('echo "Equality Verion Number..." ; cd ~/equality-blockchain ; . ./activate ; equality version')

def startcli():
    os.system('echo "Starting Equality..." ; cd ~/equality-blockchain ; . ./activate ; equality stop all ; deactivate ; cd ~/ ; cd ~/equality-blockchain ; . ./activate ; equality start farmer')

def chain():
    os.system('echo "Getting The State Of Equality Blockchain..." ; cd ~/equality-blockchain ; . ./activate ; equality show -s')

def connections():
    os.system('echo "Getting Equality Peer Connections..." ; cd ~/equality-blockchain ; . ./activate ; equality show -c')

def wallet():
    os.system('echo "Equality Wallet Is Loading..." ; cd ~/equality-blockchain ; . ./activate ; equality wallet show')

def getaddress():
    os.system('echo "Getting Equality Address..." ; cd ~/equality-blockchain ; . ./activate ; equality wallet get_address')

def gettransactions():
    os.system('echo "Getting Equality Transactions..." ; cd ~/equality-blockchain ; . ./activate ; equality wallet get_transactions')
	
def summary():
    os.system('echo "Equality Farm Summary Loading..." ; cd ~/equality-blockchain ; . ./activate ; equality farm summary')
	
def challenges():
    os.system('echo "Equality Challenges Loading..." ; cd ~/equality-blockchain ; . ./activate ; equality farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Equality Config File..." ; xdg-open ~/.equality/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Equality Log File..." ; xdg-open ~/.equality/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Equality-GUI..." ; cd ~/equality-blockchain ; . ./activate ; cd equality-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Equality-GUI installed for you." ; cd ~/equality-blockchain ; . ./activate ; sh install-gui.sh ; cd equality-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Equality Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:55421) ; echo "Process IDs On Daemon Port 55421 Closed"')             

def closefarmerport():
    os.system('echo "Closing Equality Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:9885) ; echo "Process IDs On Farmer Port 9885 Closed"')

def closeharvesterport():
    os.system('echo "Closing Equality Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:9884) ; echo "Process IDs On Harvester Port 9884 Closed"')

def closefullnodeport():
    os.system('echo "Closing Equality Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:9888) ; echo "Process IDs On Full Node Port 9888 Closed"')

def closewalletport():
    os.system('echo "Closing Equality Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:9883) ; echo "Process IDs on Wallet Port 9883 Closed"')

def listports():
    os.system('echo "List of All Equality Process IDs for Ports, Daemon 55421, Harvester 9884, Wallet 9883, Farmer 9885, Full Node 9888." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:55421,9884,9883,9885,9888')

def closeallport():
    os.system('echo "Closing All Equality Ports..." ; sudo kill -9 $(sudo lsof -t -i:55421,9884,9883,9885,9888) ; echo "All Process IDs on Ports, Daemon 55421, Harvester 9884, Wallet 9883, Farmer 9885, Full Node 9888, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Equality Folder" ; cd ~/equality-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_EqualityWindow(object):
    def setupUi(self, EqualityWindow):
        EqualityWindow.setObjectName("EqualityWindow")
        EqualityWindow.resize(483, 320)
...
#START MAIN WINDOW
        EqualityWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        EqualityWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(EqualityWindow)
...
#TAB LAYOUT
        ...
        EqualityWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(EqualityWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(EqualityWindow)

    def retranslateUi(self, EqualityWindow):
        _translate = QtCore.QCoreApplication.translate
        EqualityWindow.setWindowTitle(_translate("EqualityWindow", "Equality"))
        self.connections.setText(_translate("EqualityWindow", "Connections"))
        self.summary.setText(_translate("EqualityWindow", "Farm Summary"))
        self.config.setText(_translate("EqualityWindow", "Config"))
        self.wallet.setText(_translate("EqualityWindow", "Show Equality Wallet"))
        self.chain.setText(_translate("EqualityWindow", "State Of Equality"))
        self.startcli.setText(_translate("EqualityWindow", "Start-CLI"))
        self.startgui.setText(_translate("EqualityWindow", "Start-GUI"))
        self.log.setText(_translate("EqualityWindow", "Log"))
        self.challenges.setText(_translate("EqualityWindow", "Challenges"))
        self.stop.setText(_translate("EqualityWindow", "Stop"))
        self.terminal.setText(_translate("EqualityWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("EqualityWindow", "Dashboard"))
        self.genkey.setText(_translate("EqualityWindow", "Generate Key"))
        self.gettransactions.setText(_translate("EqualityWindow", "Get Transactions"))
        self.getaddress.setText(_translate("EqualityWindow", "Get Address"))
        self.mnemonic.setText(_translate("EqualityWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("EqualityWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("EqualityWindow", "Add Key"))
        self.keysshow.setText(_translate("EqualityWindow", "Equality Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("EqualityWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("EqualityWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("EqualityWindow", "Close Full-Node 9888"))
        self.listports.setText(_translate("EqualityWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("EqualityWindow", "Close Farmer 9885"))
        self.closewalletport.setText(_translate("EqualityWindow", "Close Wallet 9883"))
        self.closeharvesterport.setText(_translate("EqualityWindow", "Close Harvester 9884"))
        self.closedaemonport.setText(_translate("EqualityWindow", "Close Daemon 55421"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("EqualityWindow", "Ports"))
        self.installcli.setText(_translate("EqualityWindow", "Install CLI"))
        self.installgui.setText(_translate("EqualityWindow", "Install GUI"))
        self.version.setText(_translate("EqualityWindow", "Equality Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("EqualityWindow", "Install"))
        self.uninstallclient.setText(_translate("EqualityWindow", "UnInstall Equality"))
        self.updateclient.setText(_translate("EqualityWindow", "Update Equality"))
        self.deleteclient.setText(_translate("EqualityWindow", "Delete Equality"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("EqualityWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    EqualityWindow = QtWidgets.QMainWindow()
    ui = Ui_EqualityWindow()
    ui.setupUi(EqualityWindow)
    EqualityWindow.show()
    sys.exit(app.exec_()) 
