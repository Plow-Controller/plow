...
def updateclient():
    os.system('echo "Lets get Cannabis updated for you." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:54400,5548,5549,5547,5444) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.cannabis ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.cannabis -t ~/plow/old-config/ ; rm -f --recursive -d ~/cannabis-blockchain ; git clone https://github.com/CannabisChain/cannabis-blockchain.git ; cd ~/cannabis-blockchain ; sh install.sh ; . ./activate ; cannabis init ; cd ~/plow/old-config/.cannabis/mainnet ; mv db wallet -t ~/.cannabis/mainnet ; cd ~/cannabis-blockchain ; cannabis start farmer ; echo "Cannabis has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.cannabis/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Cannabis uninstalled for you." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.cannabis ; mv ~/.cannabis -t ~/plow/old-config/ ; rm -f --recursive -d ~/cannabis-blockchain ; echo "Cannabis has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Cannabis deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.cannabis ; mv ~/.cannabis -t ~/plow/old-config/ ; rm -f --recursive -d ~/cannabis-blockchain ; echo "Cannabis has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Cannabis Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis keys show')
    
def mnemonic():
    os.system('echo "Getting Active Cannabis Mnemonic Key..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Cannabis Mnemonic Key..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Cannabis Keys..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis keys add')
	
def genkey():
    os.system('echo "Generating New Cannabis Mnemonic key..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis keys generate')

def stop():
    os.system('echo "Stopping Cannabis..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis stop all')
	
def version():
    os.system('echo "Cannabis Verion Number..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis version')

def startcli():
    os.system('echo "Starting Cannabis..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis stop all ; deactivate ; cd ~/ ; cd ~/cannabis-blockchain ; . ./activate ; cannabis start farmer')

def chain():
    os.system('echo "Getting The State Of Cannabis Blockchain..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis show -s')

def connections():
    os.system('echo "Getting Cannabis Peer Connections..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis show -c')

def wallet():
    os.system('echo "Cannabis Wallet Is Loading..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis wallet show')

def getaddress():
    os.system('echo "Getting Cannabis Address..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis wallet get_address')

def gettransactions():
    os.system('echo "Getting Cannabis Transactions..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis wallet get_transactions')
	
def summary():
    os.system('echo "Cannabis Farm Summary Loading..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis farm summary')
	
def challenges():
    os.system('echo "Cannabis Challenges Loading..." ; cd ~/cannabis-blockchain ; . ./activate ; cannabis farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Cannabis Config File..." ; xdg-open ~/.cannabis/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Cannabis Log File..." ; xdg-open ~/.cannabis/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Cannabis-GUI..." ; cd ~/cannabis-blockchain ; . ./activate ; cd cannabis-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Cannabis-GUI installed for you." ; cd ~/cannabis-blockchain ; . ./activate ; sh install-gui.sh ; cd cannabis-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Cannabis Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:54400) ; echo "Process IDs On Daemon Port 54400 Closed"')             

def closefarmerport():
    os.system('echo "Closing Cannabis Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:5547) ; echo "Process IDs On Farmer Port 5547 Closed"')

def closeharvesterport():
    os.system('echo "Closing Cannabis Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:5548) ; echo "Process IDs On Harvester Port 5548 Closed"')

def closefullnodeport():
    os.system('echo "Closing Cannabis Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:5444) ; echo "Process IDs On Full Node Port 5444 Closed"')

def closewalletport():
    os.system('echo "Closing Cannabis Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:5549) ; echo "Process IDs on Wallet Port 5549 Closed"')

def listports():
    os.system('echo "List of All Cannabis Process IDs for Ports, Daemon 54400, Harvester 5548, Wallet 5549, Farmer 5547, Full Node 5444." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:54400,5548,5549,5547,5444')

def closeallport():
    os.system('echo "Closing All Cannabis Ports..." ; sudo kill -9 $(sudo lsof -t -i:54400,5548,5549,5547,5444) ; echo "All Process IDs on Ports, Daemon 54400, Harvester 5548, Wallet 5549, Farmer 5547, Full Node 5444, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Cannabis Folder" ; cd ~/cannabis-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_CannabisWindow(object):
    def setupUi(self, CannabisWindow):
        CannabisWindow.setObjectName("CannabisWindow")
        CannabisWindow.resize(483, 320)
...
#START MAIN WINDOW
        CannabisWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        CannabisWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(CannabisWindow)
...
#TAB LAYOUT
        ...
        CannabisWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(CannabisWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(CannabisWindow)

    def retranslateUi(self, CannabisWindow):
        _translate = QtCore.QCoreApplication.translate
        CannabisWindow.setWindowTitle(_translate("CannabisWindow", "Cannabis"))
        self.connections.setText(_translate("CannabisWindow", "Connections"))
        self.summary.setText(_translate("CannabisWindow", "Farm Summary"))
        self.config.setText(_translate("CannabisWindow", "Config"))
        self.wallet.setText(_translate("CannabisWindow", "Show Cannabis Wallet"))
        self.chain.setText(_translate("CannabisWindow", "State Of Cannabis"))
        self.startcli.setText(_translate("CannabisWindow", "Start-CLI"))
        self.startgui.setText(_translate("CannabisWindow", "Start-GUI"))
        self.log.setText(_translate("CannabisWindow", "Log"))
        self.challenges.setText(_translate("CannabisWindow", "Challenges"))
        self.stop.setText(_translate("CannabisWindow", "Stop"))
        self.terminal.setText(_translate("CannabisWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("CannabisWindow", "Dashboard"))
        self.genkey.setText(_translate("CannabisWindow", "Generate Key"))
        self.gettransactions.setText(_translate("CannabisWindow", "Get Transactions"))
        self.getaddress.setText(_translate("CannabisWindow", "Get Address"))
        self.mnemonic.setText(_translate("CannabisWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("CannabisWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("CannabisWindow", "Add Key"))
        self.keysshow.setText(_translate("CannabisWindow", "Cannabis Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("CannabisWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("CannabisWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("CannabisWindow", "Close Full-Node 5444"))
        self.listports.setText(_translate("CannabisWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("CannabisWindow", "Close Farmer 5547"))
        self.closewalletport.setText(_translate("CannabisWindow", "Close Wallet 5549"))
        self.closeharvesterport.setText(_translate("CannabisWindow", "Close Harvester 5548"))
        self.closedaemonport.setText(_translate("CannabisWindow", "Close Daemon 54400"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("CannabisWindow", "Ports"))
        self.installcli.setText(_translate("CannabisWindow", "Install CLI"))
        self.installgui.setText(_translate("CannabisWindow", "Install GUI"))
        self.version.setText(_translate("CannabisWindow", "Cannabis Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("CannabisWindow", "Install"))
        self.uninstallclient.setText(_translate("CannabisWindow", "UnInstall Cannabis"))
        self.updateclient.setText(_translate("CannabisWindow", "Update Cannabis"))
        self.deleteclient.setText(_translate("CannabisWindow", "Delete Cannabis"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("CannabisWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    CannabisWindow = QtWidgets.QMainWindow()
    ui = Ui_CannabisWindow()
    ui.setupUi(CannabisWindow)
    CannabisWindow.show()
    sys.exit(app.exec_()) 
