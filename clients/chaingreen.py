...
def updateclient():
    os.system('echo "Lets get Chaingreen updated for you." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:55700,8778,8749,8777,8744) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.chaingreen ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.chaingreen -t ~/plow/old-config/ ; rm -f --recursive -d ~/chaingreen-blockchain ; git clone https://github.com/ChainGreenOrg/chaingreen-blockchain.git ; cd ~/chaingreen-blockchain ; sh install.sh ; . ./activate ; chaingreen init ; cd ~/plow/old-config/.chaingreen/mainnet ; mv db wallet -t ~/.chaingreen/mainnet ; cd ~/chaingreen-blockchain ; chaingreen start farmer ; echo "Chaingreen has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.chaingreen/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Chaingreen uninstalled for you." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.chaingreen ; mv ~/.chaingreen -t ~/plow/old-config/ ; rm -f --recursive -d ~/chaingreen-blockchain ; echo "Chaingreen has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Chaingreen deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.chaingreen ; mv ~/.chaingreen -t ~/plow/old-config/ ; rm -f --recursive -d ~/chaingreen-blockchain ; echo "Chaingreen has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Chaingreen Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen keys show')
    
def mnemonic():
    os.system('echo "Getting Active Chaingreen Mnemonic Key..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Chaingreen Mnemonic Key..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Chaingreen Keys..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen keys add')
	
def genkey():
    os.system('echo "Generating New Chaingreen Mnemonic key..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen keys generate')

def stop():
    os.system('echo "Stopping Chaingreen..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen stop all')
	
def version():
    os.system('echo "Chaingreen Verion Number..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen version')

def startcli():
    os.system('echo "Starting Chaingreen..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen stop all ; deactivate ; cd ~/ ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen start farmer')

def chain():
    os.system('echo "Getting The State Of Chaingreen Blockchain..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen show -s')

def connections():
    os.system('echo "Getting Chaingreen Peer Connections..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen show -c')

def wallet():
    os.system('echo "Chaingreen Wallet Is Loading..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen wallet show')

def getaddress():
    os.system('echo "Getting Chaingreen Address..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen wallet get_address')

def gettransactions():
    os.system('echo "Getting Chaingreen Transactions..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen wallet get_transactions')
	
def summary():
    os.system('echo "Chaingreen Farm Summary Loading..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen farm summary')
	
def challenges():
    os.system('echo "Chaingreen Challenges Loading..." ; cd ~/chaingreen-blockchain ; . ./activate ; chaingreen farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Chaingreen Config File..." ; xdg-open ~/.chaingreen/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Chaingreen Log File..." ; xdg-open ~/.chaingreen/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Chaingreen-GUI..." ; cd ~/chaingreen-blockchain ; . ./activate ; cd chaingreen-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Chaingreen-GUI installed for you." ; cd ~/chaingreen-blockchain ; . ./activate ; sh install-gui.sh ; cd chaingreen-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Chaingreen Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:55700) ; echo "Process IDs On Daemon Port 55700 Closed"')             

def closefarmerport():
    os.system('echo "Closing Chaingreen Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:8777) ; echo "Process IDs On Farmer Port 8777 Closed"')

def closeharvesterport():
    os.system('echo "Closing Chaingreen Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:8778) ; echo "Process IDs On Harvester Port 8778 Closed"')

def closefullnodeport():
    os.system('echo "Closing Chaingreen Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:8744) ; echo "Process IDs On Full Node Port 8744 Closed"')

def closewalletport():
    os.system('echo "Closing Chaingreen Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:8749) ; echo "Process IDs on Wallet Port 8749 Closed"')

def listports():
    os.system('echo "List of All Chaingreen Process IDs for Ports, Daemon 55700, Harvester 8778, Wallet 8749, Farmer 8777, Full Node 8744." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:55700,8778,8749,8777,8744')

def closeallport():
    os.system('echo "Closing All Chaingreen Ports..." ; sudo kill -9 $(sudo lsof -t -i:55700,8778,8749,8777,8744) ; echo "All Process IDs on Ports, Daemon 55700, Harvester 8778, Wallet 8749, Farmer 8777, Full Node 8744, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Chaingreen Folder" ; cd ~/chaingreen-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_ChaingreenWindow(object):
    def setupUi(self, ChaingreenWindow):
        ChaingreenWindow.setObjectName("ChaingreenWindow")
        ChaingreenWindow.resize(483, 320)
...
#START MAIN WINDOW
        ChaingreenWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ChaingreenWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(ChaingreenWindow)
...
#TAB LAYOUT
        ...
        ChaingreenWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(ChaingreenWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(ChaingreenWindow)

    def retranslateUi(self, ChaingreenWindow):
        _translate = QtCore.QCoreApplication.translate
        ChaingreenWindow.setWindowTitle(_translate("ChaingreenWindow", "Chaingreen"))
        self.connections.setText(_translate("ChaingreenWindow", "Connections"))
        self.summary.setText(_translate("ChaingreenWindow", "Farm Summary"))
        self.config.setText(_translate("ChaingreenWindow", "Config"))
        self.wallet.setText(_translate("ChaingreenWindow", "Show Chaingreen Wallet"))
        self.chain.setText(_translate("ChaingreenWindow", "State Of Chaingreen"))
        self.startcli.setText(_translate("ChaingreenWindow", "Start-CLI"))
        self.startgui.setText(_translate("ChaingreenWindow", "Start-GUI"))
        self.log.setText(_translate("ChaingreenWindow", "Log"))
        self.challenges.setText(_translate("ChaingreenWindow", "Challenges"))
        self.stop.setText(_translate("ChaingreenWindow", "Stop"))
        self.terminal.setText(_translate("ChaingreenWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("ChaingreenWindow", "Dashboard"))
        self.genkey.setText(_translate("ChaingreenWindow", "Generate Key"))
        self.gettransactions.setText(_translate("ChaingreenWindow", "Get Transactions"))
        self.getaddress.setText(_translate("ChaingreenWindow", "Get Address"))
        self.mnemonic.setText(_translate("ChaingreenWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("ChaingreenWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("ChaingreenWindow", "Add Key"))
        self.keysshow.setText(_translate("ChaingreenWindow", "Chaingreen Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("ChaingreenWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("ChaingreenWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("ChaingreenWindow", "Close Full-Node 8744"))
        self.listports.setText(_translate("ChaingreenWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("ChaingreenWindow", "Close Farmer 8777"))
        self.closewalletport.setText(_translate("ChaingreenWindow", "Close Wallet 8749"))
        self.closeharvesterport.setText(_translate("ChaingreenWindow", "Close Harvester 8778"))
        self.closedaemonport.setText(_translate("ChaingreenWindow", "Close Daemon 55700"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("ChaingreenWindow", "Ports"))
        self.installcli.setText(_translate("ChaingreenWindow", "Install CLI"))
        self.installgui.setText(_translate("ChaingreenWindow", "Install GUI"))
        self.version.setText(_translate("ChaingreenWindow", "Chaingreen Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("ChaingreenWindow", "Install"))
        self.uninstallclient.setText(_translate("ChaingreenWindow", "UnInstall Chaingreen"))
        self.updateclient.setText(_translate("ChaingreenWindow", "Update Chaingreen"))
        self.deleteclient.setText(_translate("ChaingreenWindow", "Delete Chaingreen"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("ChaingreenWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ChaingreenWindow = QtWidgets.QMainWindow()
    ui = Ui_ChaingreenWindow()
    ui.setupUi(ChaingreenWindow)
    ChaingreenWindow.show()
    sys.exit(app.exec_()) 
