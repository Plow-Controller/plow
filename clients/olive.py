...
def updateclient():
    os.system('echo "Lets get Olive updated for you." ; cd ~/Olive-blockchain ; . ./activate ; olive stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:56309,7663,8999,7662,7333) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.olive ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.olive -t ~/plow/old-config/ ; rm -f --recursive -d ~/Olive-blockchain ; git clone https://github.com/Olive-blockchain/Olive-blockchain.git ; cd ~/Olive-blockchain ; sh install.sh ; . ./activate ; olive init ; cd ~/plow/old-config/.olive/mainnet ; mv db wallet -t ~/.olive/mainnet ; cd ~/Olive-blockchain ; olive start farmer ; echo "Olive has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.olive/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Olive uninstalled for you." ; cd ~/Olive-blockchain ; . ./activate ; olive stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.olive ; mv ~/.olive -t ~/plow/old-config/ ; rm -f --recursive -d ~/Olive-blockchain ; echo "Olive has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Olive deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.olive ; mv ~/.olive -t ~/plow/old-config/ ; rm -f --recursive -d ~/Olive-blockchain ; echo "Olive has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Olive Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/Olive-blockchain ; . ./activate ; olive keys show')
    
def mnemonic():
    os.system('echo "Getting Active Olive Mnemonic Key..." ; cd ~/Olive-blockchain ; . ./activate ; olive keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Olive Mnemonic Key..." ; cd ~/Olive-blockchain ; . ./activate ; olive generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Olive Keys..." ; cd ~/Olive-blockchain ; . ./activate ; olive keys add')
	
def genkey():
    os.system('echo "Generating New Olive Mnemonic key..." ; cd ~/Olive-blockchain ; . ./activate ; olive keys generate')

def stop():
    os.system('echo "Stopping Olive..." ; cd ~/Olive-blockchain ; . ./activate ; olive stop all')
	
def version():
    os.system('echo "Olive Verion Number..." ; cd ~/Olive-blockchain ; . ./activate ; olive version')

def startcli():
    os.system('echo "Starting Olive..." ; cd ~/Olive-blockchain ; . ./activate ; olive stop all ; deactivate ; cd ~/ ; cd ~/Olive-blockchain ; . ./activate ; olive start farmer')

def chain():
    os.system('echo "Getting The State Of Olive Blockchain..." ; cd ~/Olive-blockchain ; . ./activate ; olive show -s')

def connections():
    os.system('echo "Getting Olive Peer Connections..." ; cd ~/Olive-blockchain ; . ./activate ; olive show -c')

def wallet():
    os.system('echo "Olive Wallet Is Loading..." ; cd ~/Olive-blockchain ; . ./activate ; olive wallet show')

def getaddress():
    os.system('echo "Getting Olive Address..." ; cd ~/Olive-blockchain ; . ./activate ; olive wallet get_address')

def gettransactions():
    os.system('echo "Getting Olive Transactions..." ; cd ~/Olive-blockchain ; . ./activate ; olive wallet get_transactions')
	
def summary():
    os.system('echo "Olive Farm Summary Loading..." ; cd ~/Olive-blockchain ; . ./activate ; olive farm summary')
	
def challenges():
    os.system('echo "Olive Challenges Loading..." ; cd ~/Olive-blockchain ; . ./activate ; olive farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Olive Config File..." ; xdg-open ~/.olive/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Olive Log File..." ; xdg-open ~/.olive/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Olive-GUI..." ; cd ~/Olive-blockchain ; . ./activate ; cd olive-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Olive-GUI installed for you." ; cd ~/Olive-blockchain ; . ./activate ; sh install-gui.sh ; cd olive-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Olive Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:56309) ; echo "Process IDs On Daemon Port 56309 Closed"')             

def closefarmerport():
    os.system('echo "Closing Olive Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:7662) ; echo "Process IDs On Farmer Port 7662 Closed"')

def closeharvesterport():
    os.system('echo "Closing Olive Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:7663) ; echo "Process IDs On Harvester Port 7663 Closed"')

def closefullnodeport():
    os.system('echo "Closing Olive Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:7333) ; echo "Process IDs On Full Node Port 7333 Closed"')

def closewalletport():
    os.system('echo "Closing Olive Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:8999) ; echo "Process IDs on Wallet Port 8999 Closed"')

def listports():
    os.system('echo "List of All Olive Process IDs for Ports, Daemon 56309, Harvester 7663, Wallet 8999, Farmer 7662, Full Node 7333." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:56309,7663,8999,7662,7333')

def closeallport():
    os.system('echo "Closing All Olive Ports..." ; sudo kill -9 $(sudo lsof -t -i:56309,7663,8999,7662,7333) ; echo "All Process IDs on Ports, Daemon 56309, Harvester 7663, Wallet 8999, Farmer 7662, Full Node 7333, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Olive Folder" ; cd ~/Olive-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_OliveWindow(object):
    def setupUi(self, OliveWindow):
        OliveWindow.setObjectName("OliveWindow")
        OliveWindow.resize(483, 320)
...
#START MAIN WINDOW
        OliveWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        OliveWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(OliveWindow)
...
#TAB LAYOUT
        ...
        OliveWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(OliveWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(OliveWindow)

    def retranslateUi(self, OliveWindow):
        _translate = QtCore.QCoreApplication.translate
        OliveWindow.setWindowTitle(_translate("OliveWindow", "Olive"))
        self.connections.setText(_translate("OliveWindow", "Connections"))
        self.summary.setText(_translate("OliveWindow", "Farm Summary"))
        self.config.setText(_translate("OliveWindow", "Config"))
        self.wallet.setText(_translate("OliveWindow", "Show Olive Wallet"))
        self.chain.setText(_translate("OliveWindow", "State Of Olive"))
        self.startcli.setText(_translate("OliveWindow", "Start-CLI"))
        self.startgui.setText(_translate("OliveWindow", "Start-GUI"))
        self.log.setText(_translate("OliveWindow", "Log"))
        self.challenges.setText(_translate("OliveWindow", "Challenges"))
        self.stop.setText(_translate("OliveWindow", "Stop"))
        self.terminal.setText(_translate("OliveWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("OliveWindow", "Dashboard"))
        self.genkey.setText(_translate("OliveWindow", "Generate Key"))
        self.gettransactions.setText(_translate("OliveWindow", "Get Transactions"))
        self.getaddress.setText(_translate("OliveWindow", "Get Address"))
        self.mnemonic.setText(_translate("OliveWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("OliveWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("OliveWindow", "Add Key"))
        self.keysshow.setText(_translate("OliveWindow", "Olive Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("OliveWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("OliveWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("OliveWindow", "Close Full-Node 7333"))
        self.listports.setText(_translate("OliveWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("OliveWindow", "Close Farmer 7662"))
        self.closewalletport.setText(_translate("OliveWindow", "Close Wallet 8999"))
        self.closeharvesterport.setText(_translate("OliveWindow", "Close Harvester 7663"))
        self.closedaemonport.setText(_translate("OliveWindow", "Close Daemon 56309"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("OliveWindow", "Ports"))
        self.installcli.setText(_translate("OliveWindow", "Install CLI"))
        self.installgui.setText(_translate("OliveWindow", "Install GUI"))
        self.version.setText(_translate("OliveWindow", "Olive Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("OliveWindow", "Install"))
        self.uninstallclient.setText(_translate("OliveWindow", "UnInstall Olive"))
        self.updateclient.setText(_translate("OliveWindow", "Update Olive"))
        self.deleteclient.setText(_translate("OliveWindow", "Delete Olive"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("OliveWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    OliveWindow = QtWidgets.QMainWindow()
    ui = Ui_OliveWindow()
    ui.setupUi(OliveWindow)
    OliveWindow.show()
    sys.exit(app.exec_()) 
