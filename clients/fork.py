...
def updateclient():
    os.system('echo "Lets get Fork updated for you." ; cd ~/fork-blockchain ; . ./activate ; fork stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:33376,16626,16522,16625,3675) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.fork ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.fork -t ~/plow/old-config/ ; rm -f --recursive -d ~/fork-blockchain ; git clone https://github.com/Fork-Network/fork-blockchain.git ; cd ~/fork-blockchain ; sh install.sh ; . ./activate ; fork init ; cd ~/plow/old-config/.fork/mainnet ; mv db wallet -t ~/.fork/mainnet ; cd ~/fork-blockchain ; fork start farmer ; echo "Fork has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.fork/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Fork uninstalled for you." ; cd ~/fork-blockchain ; . ./activate ; fork stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.fork ; mv ~/.fork -t ~/plow/old-config/ ; rm -f --recursive -d ~/fork-blockchain ; echo "Fork has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Fork deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.fork ; mv ~/.fork -t ~/plow/old-config/ ; rm -f --recursive -d ~/fork-blockchain ; echo "Fork has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Fork Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/fork-blockchain ; . ./activate ; fork keys show')
    
def mnemonic():
    os.system('echo "Getting Active Fork Mnemonic Key..." ; cd ~/fork-blockchain ; . ./activate ; fork keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Fork Mnemonic Key..." ; cd ~/fork-blockchain ; . ./activate ; fork generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Fork Keys..." ; cd ~/fork-blockchain ; . ./activate ; fork keys add')
	
def genkey():
    os.system('echo "Generating New Fork Mnemonic key..." ; cd ~/fork-blockchain ; . ./activate ; fork keys generate')

def stop():
    os.system('echo "Stopping Fork..." ; cd ~/fork-blockchain ; . ./activate ; fork stop all')
	
def version():
    os.system('echo "Fork Verion Number..." ; cd ~/fork-blockchain ; . ./activate ; fork version')

def startcli():
    os.system('echo "Starting Fork..." ; cd ~/fork-blockchain ; . ./activate ; fork stop all ; deactivate ; cd ~/ ; cd ~/fork-blockchain ; . ./activate ; fork start farmer')

def chain():
    os.system('echo "Getting The State Of Fork Blockchain..." ; cd ~/fork-blockchain ; . ./activate ; fork show -s')

def connections():
    os.system('echo "Getting Fork Peer Connections..." ; cd ~/fork-blockchain ; . ./activate ; fork show -c')

def wallet():
    os.system('echo "Fork Wallet Is Loading..." ; cd ~/fork-blockchain ; . ./activate ; fork wallet show')

def getaddress():
    os.system('echo "Getting Fork Address..." ; cd ~/fork-blockchain ; . ./activate ; fork wallet get_address')

def gettransactions():
    os.system('echo "Getting Fork Transactions..." ; cd ~/fork-blockchain ; . ./activate ; fork wallet get_transactions')
	
def summary():
    os.system('echo "Fork Farm Summary Loading..." ; cd ~/fork-blockchain ; . ./activate ; fork farm summary')
	
def challenges():
    os.system('echo "Fork Challenges Loading..." ; cd ~/fork-blockchain ; . ./activate ; fork farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Fork Config File..." ; xdg-open ~/.fork/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Fork Log File..." ; xdg-open ~/.fork/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Fork-GUI..." ; cd ~/fork-blockchain ; . ./activate ; cd fork-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Fork-GUI installed for you." ; cd ~/fork-blockchain ; . ./activate ; sh install-gui.sh ; cd fork-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Fork Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:33376) ; echo "Process IDs On Daemon Port 33376 Closed"')             

def closefarmerport():
    os.system('echo "Closing Fork Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:16625) ; echo "Process IDs On Farmer Port 16625 Closed"')

def closeharvesterport():
    os.system('echo "Closing Fork Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:16626) ; echo "Process IDs On Harvester Port 16626 Closed"')

def closefullnodeport():
    os.system('echo "Closing Fork Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:3675) ; echo "Process IDs On Full Node Port 3675 Closed"')

def closewalletport():
    os.system('echo "Closing Fork Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:16522) ; echo "Process IDs on Wallet Port 16522 Closed"')

def listports():
    os.system('echo "List of All Fork Process IDs for Ports, Daemon 33376, Harvester 16626, Wallet 16522, Farmer 16625, Full Node 3675." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:33376,16626,16522,16625,3675')

def closeallport():
    os.system('echo "Closing All Fork Ports..." ; sudo kill -9 $(sudo lsof -t -i:33376,16626,16522,16625,3675) ; echo "All Process IDs on Ports, Daemon 33376, Harvester 16626, Wallet 16522, Farmer 16625, Full Node 3675, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Fork Folder" ; cd ~/fork-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_ForkWindow(object):
    def setupUi(self, ForkWindow):
        ForkWindow.setObjectName("ForkWindow")
        ForkWindow.resize(483, 320)
...
#START MAIN WINDOW
        ForkWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ForkWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(ForkWindow)
...
#TAB LAYOUT
        ...
        ForkWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(ForkWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(ForkWindow)

    def retranslateUi(self, ForkWindow):
        _translate = QtCore.QCoreApplication.translate
        ForkWindow.setWindowTitle(_translate("ForkWindow", "Fork"))
        self.connections.setText(_translate("ForkWindow", "Connections"))
        self.summary.setText(_translate("ForkWindow", "Farm Summary"))
        self.config.setText(_translate("ForkWindow", "Config"))
        self.wallet.setText(_translate("ForkWindow", "Show Fork Wallet"))
        self.chain.setText(_translate("ForkWindow", "State Of Fork"))
        self.startcli.setText(_translate("ForkWindow", "Start-CLI"))
        self.startgui.setText(_translate("ForkWindow", "Start-GUI"))
        self.log.setText(_translate("ForkWindow", "Log"))
        self.challenges.setText(_translate("ForkWindow", "Challenges"))
        self.stop.setText(_translate("ForkWindow", "Stop"))
        self.terminal.setText(_translate("ForkWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("ForkWindow", "Dashboard"))
        self.genkey.setText(_translate("ForkWindow", "Generate Key"))
        self.gettransactions.setText(_translate("ForkWindow", "Get Transactions"))
        self.getaddress.setText(_translate("ForkWindow", "Get Address"))
        self.mnemonic.setText(_translate("ForkWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("ForkWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("ForkWindow", "Add Key"))
        self.keysshow.setText(_translate("ForkWindow", "Fork Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("ForkWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("ForkWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("ForkWindow", "Close Full-Node 3675"))
        self.listports.setText(_translate("ForkWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("ForkWindow", "Close Farmer 16625"))
        self.closewalletport.setText(_translate("ForkWindow", "Close Wallet 16522"))
        self.closeharvesterport.setText(_translate("ForkWindow", "Close Harvester 16626"))
        self.closedaemonport.setText(_translate("ForkWindow", "Close Daemon 33376"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("ForkWindow", "Ports"))
        self.installcli.setText(_translate("ForkWindow", "Install CLI"))
        self.installgui.setText(_translate("ForkWindow", "Install GUI"))
        self.version.setText(_translate("ForkWindow", "Fork Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("ForkWindow", "Install"))
        self.uninstallclient.setText(_translate("ForkWindow", "UnInstall Fork"))
        self.updateclient.setText(_translate("ForkWindow", "Update Fork"))
        self.deleteclient.setText(_translate("ForkWindow", "Delete Fork"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("ForkWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ForkWindow = QtWidgets.QMainWindow()
    ui = Ui_ForkWindow()
    ui.setupUi(ForkWindow)
    ForkWindow.show()
    sys.exit(app.exec_()) 
