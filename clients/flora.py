...
def updateclient():
    os.system('echo "Lets get Flora updated for you." ; cd ~/flora-blockchain ; . ./activate ; flora stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:55422,18648,18649,18647,18644) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.flora ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.flora -t ~/plow/old-config/ ; rm -f --recursive -d ~/flora-blockchain ; git clone https://github.com/Flora-Network/flora-blockchain.git ; cd ~/flora-blockchain ; sh install.sh ; . ./activate ; flora init ; cd ~/plow/old-config/.flora/mainnet ; mv db wallet -t ~/.flora/mainnet ; cd ~/flora-blockchain ; flora start farmer ; echo "Flora has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.flora/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Flora uninstalled for you." ; cd ~/flora-blockchain ; . ./activate ; flora stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.flora ; mv ~/.flora -t ~/plow/old-config/ ; rm -f --recursive -d ~/flora-blockchain ; echo "Flora has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Flora deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.flora ; mv ~/.flora -t ~/plow/old-config/ ; rm -f --recursive -d ~/flora-blockchain ; echo "Flora has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Flora Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/flora-blockchain ; . ./activate ; flora keys show')
    
def mnemonic():
    os.system('echo "Getting Active Flora Mnemonic Key..." ; cd ~/flora-blockchain ; . ./activate ; flora keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Flora Mnemonic Key..." ; cd ~/flora-blockchain ; . ./activate ; flora generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Flora Keys..." ; cd ~/flora-blockchain ; . ./activate ; flora keys add')
	
def genkey():
    os.system('echo "Generating New Flora Mnemonic key..." ; cd ~/flora-blockchain ; . ./activate ; flora keys generate')

def stop():
    os.system('echo "Stopping Flora..." ; cd ~/flora-blockchain ; . ./activate ; flora stop all')
	
def version():
    os.system('echo "Flora Verion Number..." ; cd ~/flora-blockchain ; . ./activate ; flora version')

def startcli():
    os.system('echo "Starting Flora..." ; cd ~/flora-blockchain ; . ./activate ; flora stop all ; deactivate ; cd ~/ ; cd ~/flora-blockchain ; . ./activate ; flora start farmer')

def chain():
    os.system('echo "Getting The State Of Flora Blockchain..." ; cd ~/flora-blockchain ; . ./activate ; flora show -s')

def connections():
    os.system('echo "Getting Flora Peer Connections..." ; cd ~/flora-blockchain ; . ./activate ; flora show -c')

def wallet():
    os.system('echo "Flora Wallet Is Loading..." ; cd ~/flora-blockchain ; . ./activate ; flora wallet show')

def getaddress():
    os.system('echo "Getting Flora Address..." ; cd ~/flora-blockchain ; . ./activate ; flora wallet get_address')

def gettransactions():
    os.system('echo "Getting Flora Transactions..." ; cd ~/flora-blockchain ; . ./activate ; flora wallet get_transactions')
	
def summary():
    os.system('echo "Flora Farm Summary Loading..." ; cd ~/flora-blockchain ; . ./activate ; flora farm summary')
	
def challenges():
    os.system('echo "Flora Challenges Loading..." ; cd ~/flora-blockchain ; . ./activate ; flora farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Flora Config File..." ; xdg-open ~/.flora/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Flora Log File..." ; xdg-open ~/.flora/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Flora-GUI..." ; cd ~/flora-blockchain ; . ./activate ; cd flora-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Flora-GUI installed for you." ; cd ~/flora-blockchain ; . ./activate ; sh install-gui.sh ; cd flora-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Flora Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:55422) ; echo "Process IDs On Daemon Port 55422 Closed"')             

def closefarmerport():
    os.system('echo "Closing Flora Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:18647) ; echo "Process IDs On Farmer Port 18647 Closed"')

def closeharvesterport():
    os.system('echo "Closing Flora Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:18648) ; echo "Process IDs On Harvester Port 18648 Closed"')

def closefullnodeport():
    os.system('echo "Closing Flora Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:18644) ; echo "Process IDs On Full Node Port 18644 Closed"')

def closewalletport():
    os.system('echo "Closing Flora Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:18649) ; echo "Process IDs on Wallet Port 18649 Closed"')

def listports():
    os.system('echo "List of All Flora Process IDs for Ports, Daemon 55422, Harvester 18648, Wallet 18649, Farmer 18647, Full Node 18644." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:55422,18648,18649,18647,18644')

def closeallport():
    os.system('echo "Closing All Flora Ports..." ; sudo kill -9 $(sudo lsof -t -i:55422,18648,18649,18647,18644) ; echo "All Process IDs on Ports, Daemon 55422, Harvester 18648, Wallet 18649, Farmer 18647, Full Node 18644, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Flora Folder" ; cd ~/flora-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_FloraWindow(object):
    def setupUi(self, FloraWindow):
        FloraWindow.setObjectName("FloraWindow")
        FloraWindow.resize(483, 320)
...
#START MAIN WINDOW
        FloraWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        FloraWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(FloraWindow)
...
#TAB LAYOUT
        ...
        FloraWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(FloraWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(FloraWindow)

    def retranslateUi(self, FloraWindow):
        _translate = QtCore.QCoreApplication.translate
        FloraWindow.setWindowTitle(_translate("FloraWindow", "Flora"))
        self.connections.setText(_translate("FloraWindow", "Connections"))
        self.summary.setText(_translate("FloraWindow", "Farm Summary"))
        self.config.setText(_translate("FloraWindow", "Config"))
        self.wallet.setText(_translate("FloraWindow", "Show Flora Wallet"))
        self.chain.setText(_translate("FloraWindow", "State Of Flora"))
        self.startcli.setText(_translate("FloraWindow", "Start-CLI"))
        self.startgui.setText(_translate("FloraWindow", "Start-GUI"))
        self.log.setText(_translate("FloraWindow", "Log"))
        self.challenges.setText(_translate("FloraWindow", "Challenges"))
        self.stop.setText(_translate("FloraWindow", "Stop"))
        self.terminal.setText(_translate("FloraWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("FloraWindow", "Dashboard"))
        self.genkey.setText(_translate("FloraWindow", "Generate Key"))
        self.gettransactions.setText(_translate("FloraWindow", "Get Transactions"))
        self.getaddress.setText(_translate("FloraWindow", "Get Address"))
        self.mnemonic.setText(_translate("FloraWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("FloraWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("FloraWindow", "Add Key"))
        self.keysshow.setText(_translate("FloraWindow", "Flora Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("FloraWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("FloraWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("FloraWindow", "Close Full-Node 18644"))
        self.listports.setText(_translate("FloraWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("FloraWindow", "Close Farmer 18647"))
        self.closewalletport.setText(_translate("FloraWindow", "Close Wallet 18649"))
        self.closeharvesterport.setText(_translate("FloraWindow", "Close Harvester 18648"))
        self.closedaemonport.setText(_translate("FloraWindow", "Close Daemon 55422"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("FloraWindow", "Ports"))
        self.installcli.setText(_translate("FloraWindow", "Install CLI"))
        self.installgui.setText(_translate("FloraWindow", "Install GUI"))
        self.version.setText(_translate("FloraWindow", "Flora Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("FloraWindow", "Install"))
        self.uninstallclient.setText(_translate("FloraWindow", "UnInstall Flora"))
        self.updateclient.setText(_translate("FloraWindow", "Update Flora"))
        self.deleteclient.setText(_translate("FloraWindow", "Delete Flora"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("FloraWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    FloraWindow = QtWidgets.QMainWindow()
    ui = Ui_FloraWindow()
    ui.setupUi(FloraWindow)
    FloraWindow.show()
    sys.exit(app.exec_()) 
