...
def updateclient():
    os.system('echo "Lets get Tad updated for you." ; cd ~/tad-blockchain ; . ./activate ; tad stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:4400,4448,4449,4447,4044) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.tad ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.tad -t ~/plow/old-config/ ; rm -f --recursive -d ~/tad-blockchain ; git clone https://github.com/Tad-Network/tad-blockchain.git ; cd ~/tad-blockchain ; sh install.sh ; . ./activate ; tad init ; cd ~/plow/old-config/.tad/mainnet ; mv db wallet -t ~/.tad/mainnet ; cd ~/tad-blockchain ; tad start farmer ; echo "Tad has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.tad/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Tad uninstalled for you." ; cd ~/tad-blockchain ; . ./activate ; tad stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.tad ; mv ~/.tad -t ~/plow/old-config/ ; rm -f --recursive -d ~/tad-blockchain ; echo "Tad has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Tad deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.tad ; mv ~/.tad -t ~/plow/old-config/ ; rm -f --recursive -d ~/tad-blockchain ; echo "Tad has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Tad Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/tad-blockchain ; . ./activate ; tad keys show')
    
def mnemonic():
    os.system('echo "Getting Active Tad Mnemonic Key..." ; cd ~/tad-blockchain ; . ./activate ; tad keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Tad Mnemonic Key..." ; cd ~/tad-blockchain ; . ./activate ; tad generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Tad Keys..." ; cd ~/tad-blockchain ; . ./activate ; tad keys add')
	
def genkey():
    os.system('echo "Generating New Tad Mnemonic key..." ; cd ~/tad-blockchain ; . ./activate ; tad keys generate')

def stop():
    os.system('echo "Stopping Tad..." ; cd ~/tad-blockchain ; . ./activate ; tad stop all')
	
def version():
    os.system('echo "Tad Verion Number..." ; cd ~/tad-blockchain ; . ./activate ; tad version')

def startcli():
    os.system('echo "Starting Tad..." ; cd ~/tad-blockchain ; . ./activate ; tad stop all ; deactivate ; cd ~/ ; cd ~/tad-blockchain ; . ./activate ; tad start farmer')

def chain():
    os.system('echo "Getting The State Of Tad Blockchain..." ; cd ~/tad-blockchain ; . ./activate ; tad show -s')

def connections():
    os.system('echo "Getting Tad Peer Connections..." ; cd ~/tad-blockchain ; . ./activate ; tad show -c')

def wallet():
    os.system('echo "Tad Wallet Is Loading..." ; cd ~/tad-blockchain ; . ./activate ; tad wallet show')

def getaddress():
    os.system('echo "Getting Tad Address..." ; cd ~/tad-blockchain ; . ./activate ; tad wallet get_address')

def gettransactions():
    os.system('echo "Getting Tad Transactions..." ; cd ~/tad-blockchain ; . ./activate ; tad wallet get_transactions')
	
def summary():
    os.system('echo "Tad Farm Summary Loading..." ; cd ~/tad-blockchain ; . ./activate ; tad farm summary')
	
def challenges():
    os.system('echo "Tad Challenges Loading..." ; cd ~/tad-blockchain ; . ./activate ; tad farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Tad Config File..." ; xdg-open ~/.tad/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Tad Log File..." ; xdg-open ~/.tad/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Tad-GUI..." ; cd ~/tad-blockchain ; . ./activate ; cd tad-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Tad-GUI installed for you." ; cd ~/tad-blockchain ; . ./activate ; sh install-gui.sh ; cd tad-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Tad Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:4400) ; echo "Process IDs On Daemon Port 4400 Closed"')             

def closefarmerport():
    os.system('echo "Closing Tad Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:4447) ; echo "Process IDs On Farmer Port 4447 Closed"')

def closeharvesterport():
    os.system('echo "Closing Tad Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:4448) ; echo "Process IDs On Harvester Port 4448 Closed"')

def closefullnodeport():
    os.system('echo "Closing Tad Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:4044) ; echo "Process IDs On Full Node Port 4044 Closed"')

def closewalletport():
    os.system('echo "Closing Tad Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:4449) ; echo "Process IDs on Wallet Port 4449 Closed"')

def listports():
    os.system('echo "List of All Tad Process IDs for Ports, Daemon 4400, Harvester 4448, Wallet 4449, Farmer 4447, Full Node 4044." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:4400,4448,4449,4447,4044')

def closeallport():
    os.system('echo "Closing All Tad Ports..." ; sudo kill -9 $(sudo lsof -t -i:4400,4448,4449,4447,4044) ; echo "All Process IDs on Ports, Daemon 4400, Harvester 4448, Wallet 4449, Farmer 4447, Full Node 4044, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Tad Folder" ; cd ~/tad-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_TadWindow(object):
    def setupUi(self, TadWindow):
        TadWindow.setObjectName("TadWindow")
        TadWindow.resize(483, 320)
...
#START MAIN WINDOW
        TadWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        TadWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(TadWindow)
...
#TAB LAYOUT
        ...
        TadWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(TadWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(TadWindow)

    def retranslateUi(self, TadWindow):
        _translate = QtCore.QCoreApplication.translate
        TadWindow.setWindowTitle(_translate("TadWindow", "Tad"))
        self.connections.setText(_translate("TadWindow", "Connections"))
        self.summary.setText(_translate("TadWindow", "Farm Summary"))
        self.config.setText(_translate("TadWindow", "Config"))
        self.wallet.setText(_translate("TadWindow", "Show Tad Wallet"))
        self.chain.setText(_translate("TadWindow", "State Of Tad"))
        self.startcli.setText(_translate("TadWindow", "Start-CLI"))
        self.startgui.setText(_translate("TadWindow", "Start-GUI"))
        self.log.setText(_translate("TadWindow", "Log"))
        self.challenges.setText(_translate("TadWindow", "Challenges"))
        self.stop.setText(_translate("TadWindow", "Stop"))
        self.terminal.setText(_translate("TadWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("TadWindow", "Dashboard"))
        self.genkey.setText(_translate("TadWindow", "Generate Key"))
        self.gettransactions.setText(_translate("TadWindow", "Get Transactions"))
        self.getaddress.setText(_translate("TadWindow", "Get Address"))
        self.mnemonic.setText(_translate("TadWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("TadWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("TadWindow", "Add Key"))
        self.keysshow.setText(_translate("TadWindow", "Tad Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("TadWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("TadWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("TadWindow", "Close Full-Node 4044"))
        self.listports.setText(_translate("TadWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("TadWindow", "Close Farmer 4447"))
        self.closewalletport.setText(_translate("TadWindow", "Close Wallet 4449"))
        self.closeharvesterport.setText(_translate("TadWindow", "Close Harvester 4448"))
        self.closedaemonport.setText(_translate("TadWindow", "Close Daemon 4400"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("TadWindow", "Ports"))
        self.installcli.setText(_translate("TadWindow", "Install CLI"))
        self.installgui.setText(_translate("TadWindow", "Install GUI"))
        self.version.setText(_translate("TadWindow", "Tad Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("TadWindow", "Install"))
        self.uninstallclient.setText(_translate("TadWindow", "UnInstall Tad"))
        self.updateclient.setText(_translate("TadWindow", "Update Tad"))
        self.deleteclient.setText(_translate("TadWindow", "Delete Tad"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("TadWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    TadWindow = QtWidgets.QMainWindow()
    ui = Ui_TadWindow()
    ui.setupUi(TadWindow)
    TadWindow.show()
    sys.exit(app.exec_()) 
