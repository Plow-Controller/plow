...
def updateclient():
    os.system('echo "Lets get Kale updated for you." ; cd ~/kale-blockchain ; . ./activate ; kale stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:56300,6334,6339,6335,6333) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.kale ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.kale -t ~/plow/old-config/ ; rm -f --recursive -d ~/kale-blockchain ; git clone https://github.com/Kale-Network/kale-blockchain.git ; cd ~/kale-blockchain ; sh install.sh ; . ./activate ; kale init ; cd ~/plow/old-config/.kale/mainnet ; mv db wallet -t ~/.kale/mainnet ; cd ~/kale-blockchain ; kale start farmer ; echo "Kale has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.kale/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Kale uninstalled for you." ; cd ~/kale-blockchain ; . ./activate ; kale stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.kale ; mv ~/.kale -t ~/plow/old-config/ ; rm -f --recursive -d ~/kale-blockchain ; echo "Kale has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Kale deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.kale ; mv ~/.kale -t ~/plow/old-config/ ; rm -f --recursive -d ~/kale-blockchain ; echo "Kale has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Kale Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/kale-blockchain ; . ./activate ; kale keys show')
    
def mnemonic():
    os.system('echo "Getting Active Kale Mnemonic Key..." ; cd ~/kale-blockchain ; . ./activate ; kale keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Kale Mnemonic Key..." ; cd ~/kale-blockchain ; . ./activate ; kale generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Kale Keys..." ; cd ~/kale-blockchain ; . ./activate ; kale keys add')
	
def genkey():
    os.system('echo "Generating New Kale Mnemonic key..." ; cd ~/kale-blockchain ; . ./activate ; kale keys generate')

def stop():
    os.system('echo "Stopping Kale..." ; cd ~/kale-blockchain ; . ./activate ; kale stop all')
	
def version():
    os.system('echo "Kale Verion Number..." ; cd ~/kale-blockchain ; . ./activate ; kale version')

def startcli():
    os.system('echo "Starting Kale..." ; cd ~/kale-blockchain ; . ./activate ; kale stop all ; deactivate ; cd ~/ ; cd ~/kale-blockchain ; . ./activate ; kale start farmer')

def chain():
    os.system('echo "Getting The State Of Kale Blockchain..." ; cd ~/kale-blockchain ; . ./activate ; kale show -s')

def connections():
    os.system('echo "Getting Kale Peer Connections..." ; cd ~/kale-blockchain ; . ./activate ; kale show -c')

def wallet():
    os.system('echo "Kale Wallet Is Loading..." ; cd ~/kale-blockchain ; . ./activate ; kale wallet show')

def getaddress():
    os.system('echo "Getting Kale Address..." ; cd ~/kale-blockchain ; . ./activate ; kale wallet get_address')

def gettransactions():
    os.system('echo "Getting Kale Transactions..." ; cd ~/kale-blockchain ; . ./activate ; kale wallet get_transactions')
	
def summary():
    os.system('echo "Kale Farm Summary Loading..." ; cd ~/kale-blockchain ; . ./activate ; kale farm summary')
	
def challenges():
    os.system('echo "Kale Challenges Loading..." ; cd ~/kale-blockchain ; . ./activate ; kale farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Kale Config File..." ; xdg-open ~/.kale/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Kale Log File..." ; xdg-open ~/.kale/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Kale-GUI..." ; cd ~/kale-blockchain ; . ./activate ; cd kale-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Kale-GUI installed for you." ; cd ~/kale-blockchain ; . ./activate ; sh install-gui.sh ; cd kale-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Kale Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:56300) ; echo "Process IDs On Daemon Port 56300 Closed"')             

def closefarmerport():
    os.system('echo "Closing Kale Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:6335) ; echo "Process IDs On Farmer Port 6335 Closed"')

def closeharvesterport():
    os.system('echo "Closing Kale Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:6334) ; echo "Process IDs On Harvester Port 6334 Closed"')

def closefullnodeport():
    os.system('echo "Closing Kale Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:6333) ; echo "Process IDs On Full Node Port 6333 Closed"')

def closewalletport():
    os.system('echo "Closing Kale Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:6339) ; echo "Process IDs on Wallet Port 6339 Closed"')

def listports():
    os.system('echo "List of All Kale Process IDs for Ports, Daemon 56300, Harvester 6334, Wallet 6339, Farmer 6335, Full Node 6333." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:56300,6334,6339,6335,6333')

def closeallport():
    os.system('echo "Closing All Kale Ports..." ; sudo kill -9 $(sudo lsof -t -i:56300,6334,6339,6335,6333) ; echo "All Process IDs on Ports, Daemon 56300, Harvester 6334, Wallet 6339, Farmer 6335, Full Node 6333, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Kale Folder" ; cd ~/kale-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_KaleWindow(object):
    def setupUi(self, KaleWindow):
        KaleWindow.setObjectName("KaleWindow")
        KaleWindow.resize(483, 320)
...
#START MAIN WINDOW
        KaleWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        KaleWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(KaleWindow)
...
#TAB LAYOUT
        ...
        KaleWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(KaleWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(KaleWindow)

    def retranslateUi(self, KaleWindow):
        _translate = QtCore.QCoreApplication.translate
        KaleWindow.setWindowTitle(_translate("KaleWindow", "Kale"))
        self.connections.setText(_translate("KaleWindow", "Connections"))
        self.summary.setText(_translate("KaleWindow", "Farm Summary"))
        self.config.setText(_translate("KaleWindow", "Config"))
        self.wallet.setText(_translate("KaleWindow", "Show Kale Wallet"))
        self.chain.setText(_translate("KaleWindow", "State Of Kale"))
        self.startcli.setText(_translate("KaleWindow", "Start-CLI"))
        self.startgui.setText(_translate("KaleWindow", "Start-GUI"))
        self.log.setText(_translate("KaleWindow", "Log"))
        self.challenges.setText(_translate("KaleWindow", "Challenges"))
        self.stop.setText(_translate("KaleWindow", "Stop"))
        self.terminal.setText(_translate("KaleWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("KaleWindow", "Dashboard"))
        self.genkey.setText(_translate("KaleWindow", "Generate Key"))
        self.gettransactions.setText(_translate("KaleWindow", "Get Transactions"))
        self.getaddress.setText(_translate("KaleWindow", "Get Address"))
        self.mnemonic.setText(_translate("KaleWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("KaleWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("KaleWindow", "Add Key"))
        self.keysshow.setText(_translate("KaleWindow", "Kale Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("KaleWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("KaleWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("KaleWindow", "Close Full-Node 6333"))
        self.listports.setText(_translate("KaleWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("KaleWindow", "Close Farmer 6335"))
        self.closewalletport.setText(_translate("KaleWindow", "Close Wallet 6339"))
        self.closeharvesterport.setText(_translate("KaleWindow", "Close Harvester 6334"))
        self.closedaemonport.setText(_translate("KaleWindow", "Close Daemon 56300"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("KaleWindow", "Ports"))
        self.installcli.setText(_translate("KaleWindow", "Install CLI"))
        self.installgui.setText(_translate("KaleWindow", "Install GUI"))
        self.version.setText(_translate("KaleWindow", "Kale Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("KaleWindow", "Install"))
        self.uninstallclient.setText(_translate("KaleWindow", "UnInstall Kale"))
        self.updateclient.setText(_translate("KaleWindow", "Update Kale"))
        self.deleteclient.setText(_translate("KaleWindow", "Delete Kale"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("KaleWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    KaleWindow = QtWidgets.QMainWindow()
    ui = Ui_KaleWindow()
    ui.setupUi(KaleWindow)
    KaleWindow.show()
    sys.exit(app.exec_()) 
