...
def updateclient():
    os.system('echo "Lets get Plotter updated for you." ; cd ~/plotter-blockchain ; . ./activate ; plotter stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:55422,4248,4249,4247,4242) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.plotter ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.plotter -t ~/plow/old-config/ ; rm -f --recursive -d ~/plotter-blockchain ; git clone https://github.com/Plotter-Network/plotter-blockchain.git ; cd ~/plotter-blockchain ; sh install.sh ; . ./activate ; plotter init ; cd ~/plow/old-config/.plotter/mainnet ; mv db wallet -t ~/.plotter/mainnet ; cd ~/plotter-blockchain ; plotter start farmer ; echo "Plotter has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.plotter/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Plotter uninstalled for you." ; cd ~/plotter-blockchain ; . ./activate ; plotter stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.plotter ; mv ~/.plotter -t ~/plow/old-config/ ; rm -f --recursive -d ~/plotter-blockchain ; echo "Plotter has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Plotter deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.plotter ; mv ~/.plotter -t ~/plow/old-config/ ; rm -f --recursive -d ~/plotter-blockchain ; echo "Plotter has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Plotter Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/plotter-blockchain ; . ./activate ; plotter keys show')
    
def mnemonic():
    os.system('echo "Getting Active Plotter Mnemonic Key..." ; cd ~/plotter-blockchain ; . ./activate ; plotter keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Plotter Mnemonic Key..." ; cd ~/plotter-blockchain ; . ./activate ; plotter generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Plotter Keys..." ; cd ~/plotter-blockchain ; . ./activate ; plotter keys add')
	
def genkey():
    os.system('echo "Generating New Plotter Mnemonic key..." ; cd ~/plotter-blockchain ; . ./activate ; plotter keys generate')

def stop():
    os.system('echo "Stopping Plotter..." ; cd ~/plotter-blockchain ; . ./activate ; plotter stop all')
	
def version():
    os.system('echo "Plotter Verion Number..." ; cd ~/plotter-blockchain ; . ./activate ; plotter version')

def startcli():
    os.system('echo "Starting Plotter..." ; cd ~/plotter-blockchain ; . ./activate ; plotter stop all ; deactivate ; cd ~/ ; cd ~/plotter-blockchain ; . ./activate ; plotter start farmer')

def chain():
    os.system('echo "Getting The State Of Plotter Blockchain..." ; cd ~/plotter-blockchain ; . ./activate ; plotter show -s')

def connections():
    os.system('echo "Getting Plotter Peer Connections..." ; cd ~/plotter-blockchain ; . ./activate ; plotter show -c')

def wallet():
    os.system('echo "Plotter Wallet Is Loading..." ; cd ~/plotter-blockchain ; . ./activate ; plotter wallet show')

def getaddress():
    os.system('echo "Getting Plotter Address..." ; cd ~/plotter-blockchain ; . ./activate ; plotter wallet get_address')

def gettransactions():
    os.system('echo "Getting Plotter Transactions..." ; cd ~/plotter-blockchain ; . ./activate ; plotter wallet get_transactions')
	
def summary():
    os.system('echo "Plotter Farm Summary Loading..." ; cd ~/plotter-blockchain ; . ./activate ; plotter farm summary')
	
def challenges():
    os.system('echo "Plotter Challenges Loading..." ; cd ~/plotter-blockchain ; . ./activate ; plotter farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Plotter Config File..." ; xdg-open ~/.plotter/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Plotter Log File..." ; xdg-open ~/.plotter/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Plotter-GUI..." ; cd ~/plotter-blockchain ; . ./activate ; cd plotter-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Plotter-GUI installed for you." ; cd ~/plotter-blockchain ; . ./activate ; sh install-gui.sh ; cd plotter-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Plotter Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:55422) ; echo "Process IDs On Daemon Port 55422 Closed"')             

def closefarmerport():
    os.system('echo "Closing Plotter Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:4247) ; echo "Process IDs On Farmer Port 4247 Closed"')

def closeharvesterport():
    os.system('echo "Closing Plotter Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:4248) ; echo "Process IDs On Harvester Port 4248 Closed"')

def closefullnodeport():
    os.system('echo "Closing Plotter Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:4242) ; echo "Process IDs On Full Node Port 4242 Closed"')

def closewalletport():
    os.system('echo "Closing Plotter Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:4249) ; echo "Process IDs on Wallet Port 4249 Closed"')

def listports():
    os.system('echo "List of All Plotter Process IDs for Ports, Daemon 55422, Harvester 4248, Wallet 4249, Farmer 4247, Full Node 4242." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:55422,4248,4249,4247,4242')

def closeallport():
    os.system('echo "Closing All Plotter Ports..." ; sudo kill -9 $(sudo lsof -t -i:55422,4248,4249,4247,4242) ; echo "All Process IDs on Ports, Daemon 55422, Harvester 4248, Wallet 4249, Farmer 4247, Full Node 4242, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Plotter Folder" ; cd ~/plotter-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_PlotterWindow(object):
    def setupUi(self, PlotterWindow):
        PlotterWindow.setObjectName("PlotterWindow")
        PlotterWindow.resize(483, 320)
...
#ICON
        ...
        PlotterWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
...
#TAB LAYOUT
    ...
    def retranslateUi(self, PlotterWindow):
        ...
        self.connections.setText(_translate("PlotterWindow", "Connections"))
        self.summary.setText(_translate("PlotterWindow", "Farm Summary"))
        self.config.setText(_translate("PlotterWindow", "Config"))
        self.wallet.setText(_translate("PlotterWindow", "Show Plotter Wallet"))
        self.chain.setText(_translate("PlotterWindow", "State Of Plotter"))
        self.startcli.setText(_translate("PlotterWindow", "Start-CLI"))
        self.startgui.setText(_translate("PlotterWindow", "Start-GUI"))
        self.log.setText(_translate("PlotterWindow", "Log"))
        self.challenges.setText(_translate("PlotterWindow", "Challenges"))
        self.stop.setText(_translate("PlotterWindow", "Stop"))
        self.terminal.setText(_translate("PlotterWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("PlotterWindow", "Dashboard"))
        self.genkey.setText(_translate("PlotterWindow", "Generate Key"))
        self.gettransactions.setText(_translate("PlotterWindow", "Get Transactions"))
        self.getaddress.setText(_translate("PlotterWindow", "Get Address"))
        self.mnemonic.setText(_translate("PlotterWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("PlotterWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("PlotterWindow", "Add Key"))
        self.keysshow.setText(_translate("PlotterWindow", "Plotter Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("PlotterWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("PlotterWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("PlotterWindow", "Close Full-Node 4242"))
        self.listports.setText(_translate("PlotterWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("PlotterWindow", "Close Farmer 4247"))
        self.closewalletport.setText(_translate("PlotterWindow", "Close Wallet 4249"))
        self.closeharvesterport.setText(_translate("PlotterWindow", "Close Harvester 4248"))
        self.closedaemonport.setText(_translate("PlotterWindow", "Close Daemon 55422"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("PlotterWindow", "Ports"))
        self.installcli.setText(_translate("PlotterWindow", "Install CLI"))
        self.installgui.setText(_translate("PlotterWindow", "Install GUI"))
        self.version.setText(_translate("PlotterWindow", "Plotter Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("PlotterWindow", "Install"))
        self.uninstallclient.setText(_translate("PlotterWindow", "UnInstall Plotter"))
        self.updateclient.setText(_translate("PlotterWindow", "Update Plotter"))
        self.deleteclient.setText(_translate("PlotterWindow", "Delete Plotter"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("PlotterWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    PlotterWindow = QtWidgets.QMainWindow()
    ui = Ui_PlotterWindow()
