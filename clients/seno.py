...
def updateclient():
    os.system('echo "Lets get Seno updated for you." ; cd ~/seno-blockchain ; . ./activate ; seno stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:55401,18448,18449,18447,18444) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.seno2 ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.seno2 -t ~/plow/old-config/ ; rm -f --recursive -d ~/seno-blockchain ; git clone https://github.com/denisio/seno-blockchain.git ; cd ~/seno-blockchain ; sh install.sh ; . ./activate ; seno init ; cd ~/plow/old-config/.seno2/mainnet ; mv db wallet -t ~/.seno2/mainnet ; cd ~/seno-blockchain ; seno start farmer ; echo "Seno has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.seno2/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Seno uninstalled for you." ; cd ~/seno-blockchain ; . ./activate ; seno stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.seno2 ; mv ~/.seno2 -t ~/plow/old-config/ ; rm -f --recursive -d ~/seno-blockchain ; echo "Seno has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Seno deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.seno2 ; mv ~/.seno2 -t ~/plow/old-config/ ; rm -f --recursive -d ~/seno-blockchain ; echo "Seno has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Seno Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/seno-blockchain ; . ./activate ; seno keys show')
    
def mnemonic():
    os.system('echo "Getting Active Seno Mnemonic Key..." ; cd ~/seno-blockchain ; . ./activate ; seno keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Seno Mnemonic Key..." ; cd ~/seno-blockchain ; . ./activate ; seno generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Seno Keys..." ; cd ~/seno-blockchain ; . ./activate ; seno keys add')
	
def genkey():
    os.system('echo "Generating New Seno Mnemonic key..." ; cd ~/seno-blockchain ; . ./activate ; seno keys generate')

def stop():
    os.system('echo "Stopping Seno..." ; cd ~/seno-blockchain ; . ./activate ; seno stop all')
	
def version():
    os.system('echo "Seno Verion Number..." ; cd ~/seno-blockchain ; . ./activate ; seno version')

def startcli():
    os.system('echo "Starting Seno..." ; cd ~/seno-blockchain ; . ./activate ; seno stop all ; deactivate ; cd ~/ ; cd ~/seno-blockchain ; . ./activate ; seno start farmer')

def chain():
    os.system('echo "Getting The State Of Seno Blockchain..." ; cd ~/seno-blockchain ; . ./activate ; seno show -s')

def connections():
    os.system('echo "Getting Seno Peer Connections..." ; cd ~/seno-blockchain ; . ./activate ; seno show -c')

def wallet():
    os.system('echo "Seno Wallet Is Loading..." ; cd ~/seno-blockchain ; . ./activate ; seno wallet show')

def getaddress():
    os.system('echo "Getting Seno Address..." ; cd ~/seno-blockchain ; . ./activate ; seno wallet get_address')

def gettransactions():
    os.system('echo "Getting Seno Transactions..." ; cd ~/seno-blockchain ; . ./activate ; seno wallet get_transactions')
	
def summary():
    os.system('echo "Seno Farm Summary Loading..." ; cd ~/seno-blockchain ; . ./activate ; seno farm summary')
	
def challenges():
    os.system('echo "Seno Challenges Loading..." ; cd ~/seno-blockchain ; . ./activate ; seno farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Seno Config File..." ; xdg-open ~/.seno2/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Seno Log File..." ; xdg-open ~/.seno2/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Seno-GUI..." ; cd ~/seno-blockchain ; . ./activate ; cd seno-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Seno-GUI installed for you." ; cd ~/seno-blockchain ; . ./activate ; sh install-gui.sh ; cd seno-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Seno Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:55401) ; echo "Process IDs On Daemon Port 55401 Closed"')             

def closefarmerport():
    os.system('echo "Closing Seno Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:18447) ; echo "Process IDs On Farmer Port 18447 Closed"')

def closeharvesterport():
    os.system('echo "Closing Seno Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:18448) ; echo "Process IDs On Harvester Port 18448 Closed"')

def closefullnodeport():
    os.system('echo "Closing Seno Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:18444) ; echo "Process IDs On Full Node Port 18444 Closed"')

def closewalletport():
    os.system('echo "Closing Seno Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:18449) ; echo "Process IDs on Wallet Port 18449 Closed"')

def listports():
    os.system('echo "List of All Seno Process IDs for Ports, Daemon 55401, Harvester 18448, Wallet 18449, Farmer 18447, Full Node 18444." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:55401,18448,18449,18447,18444')

def closeallport():
    os.system('echo "Closing All Seno Ports..." ; sudo kill -9 $(sudo lsof -t -i:55401,18448,18449,18447,18444) ; echo "All Process IDs on Ports, Daemon 55401, Harvester 18448, Wallet 18449, Farmer 18447, Full Node 18444, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Seno Folder" ; cd ~/seno-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_SenoWindow(object):
    def setupUi(self, SenoWindow):
        SenoWindow.setObjectName("SenoWindow")
        SenoWindow.resize(483, 320)
...
#START MAIN WINDOW
        SenoWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SenoWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(SenoWindow)
...
#TAB LAYOUT
        ...
        SenoWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(SenoWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(SenoWindow)

    def retranslateUi(self, SenoWindow):
        _translate = QtCore.QCoreApplication.translate
        SenoWindow.setWindowTitle(_translate("SenoWindow", "Seno"))
        self.connections.setText(_translate("SenoWindow", "Connections"))
        self.summary.setText(_translate("SenoWindow", "Farm Summary"))
        self.config.setText(_translate("SenoWindow", "Config"))
        self.wallet.setText(_translate("SenoWindow", "Show Seno Wallet"))
        self.chain.setText(_translate("SenoWindow", "State Of Seno"))
        self.startcli.setText(_translate("SenoWindow", "Start-CLI"))
        self.startgui.setText(_translate("SenoWindow", "Start-GUI"))
        self.log.setText(_translate("SenoWindow", "Log"))
        self.challenges.setText(_translate("SenoWindow", "Challenges"))
        self.stop.setText(_translate("SenoWindow", "Stop"))
        self.terminal.setText(_translate("SenoWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("SenoWindow", "Dashboard"))
        self.genkey.setText(_translate("SenoWindow", "Generate Key"))
        self.gettransactions.setText(_translate("SenoWindow", "Get Transactions"))
        self.getaddress.setText(_translate("SenoWindow", "Get Address"))
        self.mnemonic.setText(_translate("SenoWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("SenoWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("SenoWindow", "Add Key"))
        self.keysshow.setText(_translate("SenoWindow", "Seno Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("SenoWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("SenoWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("SenoWindow", "Close Full-Node 18444"))
        self.listports.setText(_translate("SenoWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("SenoWindow", "Close Farmer 18447"))
        self.closewalletport.setText(_translate("SenoWindow", "Close Wallet 18449"))
        self.closeharvesterport.setText(_translate("SenoWindow", "Close Harvester 18448"))
        self.closedaemonport.setText(_translate("SenoWindow", "Close Daemon 55401"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("SenoWindow", "Ports"))
        self.installcli.setText(_translate("SenoWindow", "Install CLI"))
        self.installgui.setText(_translate("SenoWindow", "Install GUI"))
        self.version.setText(_translate("SenoWindow", "Seno Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("SenoWindow", "Install"))
        self.uninstallclient.setText(_translate("SenoWindow", "UnInstall Seno"))
        self.updateclient.setText(_translate("SenoWindow", "Update Seno"))
        self.deleteclient.setText(_translate("SenoWindow", "Delete Seno"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("SenoWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    SenoWindow = QtWidgets.QMainWindow()
    ui = Ui_SenoWindow()
    ui.setupUi(SenoWindow)
    SenoWindow.show()
    sys.exit(app.exec_()) 
