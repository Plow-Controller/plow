...
def updateclient():
    os.system('echo "Lets get Hdd-Coin updated for you." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:25400,28448,28449,28447,28444) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.hddcoin ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.hddcoin -t ~/plow/old-config/ ; rm -f --recursive -d ~/hddcoin-blockchain ; git clone https://github.com/HDDcoin-Network/hddcoin-blockchain.git ; cd ~/hddcoin-blockchain ; sh install.sh ; . ./activate ; hddcoin init ; cd ~/plow/old-config/.hddcoin/mainnet ; mv db wallet -t ~/.hddcoin/mainnet ; cd ~/hddcoin-blockchain ; hddcoin start farmer ; echo "Hdd-Coin has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.hddcoin/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Hdd-Coin uninstalled for you." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.hddcoin ; mv ~/.hddcoin -t ~/plow/old-config/ ; rm -f --recursive -d ~/hddcoin-blockchain ; echo "Hdd-Coin has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Hdd-Coin deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.hddcoin ; mv ~/.hddcoin -t ~/plow/old-config/ ; rm -f --recursive -d ~/hddcoin-blockchain ; echo "Hdd-Coin has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Hdd-Coin Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin keys show')
    
def mnemonic():
    os.system('echo "Getting Active Hdd-Coin Mnemonic Key..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Hdd-Coin Mnemonic Key..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Please Wait For Prompt To Add Existing Hdd-Coin Keys..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin keys add')
	
def genkey():
    os.system('echo "Generating New Hdd-Coin Mnemonic key..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin keys generate')

def stop():
    os.system('echo "Stopping Hdd-Coin..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin stop all')
	
def version():
    os.system('echo "Hdd-Coin Verion Number..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin version')

def startcli():
    os.system('echo "Starting Hdd-Coin..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin stop all ; deactivate ; cd ~/ ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin start farmer')

def chain():
    os.system('echo "Getting The State Of Hdd-Coin Blockchain..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin show -s')

def connections():
    os.system('echo "Getting Hdd-Coin Peer Connections..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin show -c')

def wallet():
    os.system('echo "Hdd-Coin Wallet Is Loading..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin wallet show')

def getaddress():
    os.system('echo "Getting Hdd-Coin Address..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin wallet get_address')

def gettransactions():
    os.system('echo "Getting Hdd-Coin Transactions..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin wallet get_transactions')
	
def summary():
    os.system('echo "Hdd-Coin Farm Summary Loading..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin farm summary')
	
def challenges():
    os.system('echo "Hdd-Coin Challenges Loading..." ; cd ~/hddcoin-blockchain ; . ./activate ; hddcoin farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Hdd-Coin Config File..." ; xdg-open ~/.hddcoin/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Hdd-Coin Log File..." ; xdg-open ~/.hddcoin/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Hdd-Coin-GUI..." ; cd ~/hddcoin-blockchain ; . ./activate ; cd hddcoin-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Hdd-Coin-GUI installed for you." ; cd ~/hddcoin-blockchain ; . ./activate ; sh install-gui.sh ; cd hddcoin-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Hdd-Coin Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:25400) ; echo "Process IDs On Daemon Port 25400 Closed"')             

def closefarmerport():
    os.system('echo "Closing Hdd-Coin Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:28447) ; echo "Process IDs On Farmer Port 28447 Closed"')

def closeharvesterport():
    os.system('echo "Closing Hdd-Coin Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:28448) ; echo "Process IDs On Harvester Port 28448 Closed"')

def closefullnodeport():
    os.system('echo "Closing Hdd-Coin Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:28444) ; echo "Process IDs On Full Node Port 28444 Closed"')

def closewalletport():
    os.system('echo "Closing Hdd-Coin Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:28449) ; echo "Process IDs on Wallet Port 28449 Closed"')

def listports():
    os.system('echo "List of All Hdd-Coin Process IDs for Ports, Daemon 25400, Harvester 28448, Wallet 28449, Farmer 28447, Full Node 28444." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:25400,28448,28449,28447,28444')

def closeallport():
    os.system('echo "Closing All Hdd-Coin Ports..." ; sudo kill -9 $(sudo lsof -t -i:25400,28448,28449,28447,28444) ; echo "All Process IDs on Ports, Daemon 25400, Harvester 28448, Wallet 28449, Farmer 28447, Full Node 28444, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Hdd-Coin Folder" ; cd ~/hddcoin-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_Hdd-CoinWindow(object):
    def setupUi(self, Hdd-CoinWindow):
        Hdd-CoinWindow.setObjectName("Hdd-CoinWindow")
        Hdd-CoinWindow.resize(483, 320)
...
#START MAIN WINDOW
        Hdd-CoinWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Hdd-CoinWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(Hdd-CoinWindow)
...
#TAB LAYOUT
        ...
        Hdd-CoinWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(Hdd-CoinWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(Hdd-CoinWindow)

    def retranslateUi(self, Hdd-CoinWindow):
        _translate = QtCore.QCoreApplication.translate
        Hdd-CoinWindow.setWindowTitle(_translate("Hdd-CoinWindow", "Hdd-Coin"))
        self.connections.setText(_translate("Hdd-CoinWindow", "Connections"))
        self.summary.setText(_translate("Hdd-CoinWindow", "Farm Summary"))
        self.config.setText(_translate("Hdd-CoinWindow", "Config"))
        self.wallet.setText(_translate("Hdd-CoinWindow", "Show Hdd-Coin Wallet"))
        self.chain.setText(_translate("Hdd-CoinWindow", "State Of Hdd-Coin"))
        self.startcli.setText(_translate("Hdd-CoinWindow", "Start-CLI"))
        self.startgui.setText(_translate("Hdd-CoinWindow", "Start-GUI"))
        self.log.setText(_translate("Hdd-CoinWindow", "Log"))
        self.challenges.setText(_translate("Hdd-CoinWindow", "Challenges"))
        self.stop.setText(_translate("Hdd-CoinWindow", "Stop"))
        self.terminal.setText(_translate("Hdd-CoinWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("Hdd-CoinWindow", "Dashboard"))
        self.genkey.setText(_translate("Hdd-CoinWindow", "Generate Key"))
        self.gettransactions.setText(_translate("Hdd-CoinWindow", "Get Transactions"))
        self.getaddress.setText(_translate("Hdd-CoinWindow", "Get Address"))
        self.mnemonic.setText(_translate("Hdd-CoinWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("Hdd-CoinWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("Hdd-CoinWindow", "Add Key"))
        self.keysshow.setText(_translate("Hdd-CoinWindow", "Hdd-Coin Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("Hdd-CoinWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("Hdd-CoinWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("Hdd-CoinWindow", "Close Full-Node 28444"))
        self.listports.setText(_translate("Hdd-CoinWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("Hdd-CoinWindow", "Close Farmer 28447"))
        self.closewalletport.setText(_translate("Hdd-CoinWindow", "Close Wallet 28449"))
        self.closeharvesterport.setText(_translate("Hdd-CoinWindow", "Close Harvester 28448"))
        self.closedaemonport.setText(_translate("Hdd-CoinWindow", "Close Daemon 25400"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("Hdd-CoinWindow", "Ports"))
        self.installcli.setText(_translate("Hdd-CoinWindow", "Install CLI"))
        self.installgui.setText(_translate("Hdd-CoinWindow", "Install GUI"))
        self.version.setText(_translate("Hdd-CoinWindow", "Hdd-Coin Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("Hdd-CoinWindow", "Install"))
        self.uninstallclient.setText(_translate("Hdd-CoinWindow", "UnInstall Hdd-Coin"))
        self.updateclient.setText(_translate("Hdd-CoinWindow", "Update Hdd-Coin"))
        self.deleteclient.setText(_translate("Hdd-CoinWindow", "Delete Hdd-Coin"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("Hdd-CoinWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    Hdd-CoinWindow = QtWidgets.QMainWindow()
    ui = Ui_Hdd-CoinWindow()
    ui.setupUi(Hdd-CoinWindow)
    Hdd-CoinWindow.show()
    sys.exit(app.exec_()) 
