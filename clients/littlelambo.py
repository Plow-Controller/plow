...
def updateclient():
    os.system('echo "Lets get Little_Lambo_Coin updated for you." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:25470,28519,28519,28517,28515) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.littlelambocoin ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.littlelambocoin -t ~/plow/old-config/ ; rm -f --recursive -d ~/littlelambocoin ; git clone https://github.com/VercauterenK/littlelambocoin.git ; cd ~/littlelambocoin ; sh install.sh ; . ./activate ; littlelambocoin init ; cd ~/plow/old-config/.littlelambocoin/mainnet ; mv db wallet -t ~/.littlelambocoin/mainnet ; cd ~/littlelambocoin ; littlelambocoin start farmer ; echo "Little_Lambo_Coin has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.littlelambocoin/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Little_Lambo_Coin uninstalled for you." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.littlelambocoin ; mv ~/.littlelambocoin -t ~/plow/old-config/ ; rm -f --recursive -d ~/littlelambocoin ; echo "Little_Lambo_Coin has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Little_Lambo_Coin deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.littlelambocoin ; mv ~/.littlelambocoin -t ~/plow/old-config/ ; rm -f --recursive -d ~/littlelambocoin ; echo "Little_Lambo_Coin has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Little_Lambo_Coin Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin keys show')
    
def mnemonic():
    os.system('echo "Getting Active Little_Lambo_Coin Mnemonic Key..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Little_Lambo_Coin Mnemonic Key..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Little_Lambo_Coin Keys..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin keys add')
	
def genkey():
    os.system('echo "Generating New Little_Lambo_Coin Mnemonic key..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin keys generate')

def stop():
    os.system('echo "Stopping Little_Lambo_Coin..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin stop all')
	
def version():
    os.system('echo "Little_Lambo_Coin Verion Number..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin version')

def startcli():
    os.system('echo "Starting Little_Lambo_Coin..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin stop all ; deactivate ; cd ~/ ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin start farmer')

def chain():
    os.system('echo "Getting The State Of Little_Lambo_Coin Blockchain..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin show -s')

def connections():
    os.system('echo "Getting Little_Lambo_Coin Peer Connections..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin show -c')

def wallet():
    os.system('echo "Little_Lambo_Coin Wallet Is Loading..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin wallet show')

def getaddress():
    os.system('echo "Getting Little_Lambo_Coin Address..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin wallet get_address')

def gettransactions():
    os.system('echo "Getting Little_Lambo_Coin Transactions..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin wallet get_transactions')
	
def summary():
    os.system('echo "Little_Lambo_Coin Farm Summary Loading..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin farm summary')
	
def challenges():
    os.system('echo "Little_Lambo_Coin Challenges Loading..." ; cd ~/littlelambocoin ; . ./activate ; littlelambocoin farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Little_Lambo_Coin Config File..." ; xdg-open ~/.littlelambocoin/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Little_Lambo_Coin Log File..." ; xdg-open ~/.littlelambocoin/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Little_Lambo_Coin-GUI..." ; cd ~/littlelambocoin ; . ./activate ; cd littlelambocoin-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Little_Lambo_Coin-GUI installed for you." ; cd ~/littlelambocoin ; . ./activate ; sh install-gui.sh ; cd littlelambocoin-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Little_Lambo_Coin Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:25470) ; echo "Process IDs On Daemon Port 25470 Closed"')             

def closefarmerport():
    os.system('echo "Closing Little_Lambo_Coin Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:28517) ; echo "Process IDs On Farmer Port 28517 Closed"')

def closeharvesterport():
    os.system('echo "Closing Little_Lambo_Coin Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:28519) ; echo "Process IDs On Harvester Port 28519 Closed"')

def closefullnodeport():
    os.system('echo "Closing Little_Lambo_Coin Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:28515) ; echo "Process IDs On Full Node Port 28515 Closed"')

def closewalletport():
    os.system('echo "Closing Little_Lambo_Coin Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:28519) ; echo "Process IDs on Wallet Port 28519 Closed"')

def listports():
    os.system('echo "List of All Little_Lambo_Coin Process IDs for Ports, Daemon 25470, Harvester 28519, Wallet 28519, Farmer 28517, Full Node 28515." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:25470,28519,28519,28517,28515')

def closeallport():
    os.system('echo "Closing All Little_Lambo_Coin Ports..." ; sudo kill -9 $(sudo lsof -t -i:25470,28519,28519,28517,28515) ; echo "All Process IDs on Ports, Daemon 25470, Harvester 28519, Wallet 28519, Farmer 28517, Full Node 28515, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Little_Lambo_Coin Folder" ; cd ~/littlelambocoin ; x-terminal-emulator -- ', shell =True)


class Ui_Little_Lambo_CoinWindow(object):
    def setupUi(self, Little_Lambo_CoinWindow):
        Little_Lambo_CoinWindow.setObjectName("Little_Lambo_CoinWindow")
        Little_Lambo_CoinWindow.resize(483, 320)
...
#START MAIN WINDOW
        Little_Lambo_CoinWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Little_Lambo_CoinWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(Little_Lambo_CoinWindow)
...
#TAB LAYOUT
        ...
        Little_Lambo_CoinWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(Little_Lambo_CoinWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(Little_Lambo_CoinWindow)

    def retranslateUi(self, Little_Lambo_CoinWindow):
        _translate = QtCore.QCoreApplication.translate
        Little_Lambo_CoinWindow.setWindowTitle(_translate("Little_Lambo_CoinWindow", "Little_Lambo_Coin"))
        self.connections.setText(_translate("Little_Lambo_CoinWindow", "Connections"))
        self.summary.setText(_translate("Little_Lambo_CoinWindow", "Farm Summary"))
        self.config.setText(_translate("Little_Lambo_CoinWindow", "Config"))
        self.wallet.setText(_translate("Little_Lambo_CoinWindow", "Show Little_Lambo_Coin Wallet"))
        self.chain.setText(_translate("Little_Lambo_CoinWindow", "State Of Little_Lambo_Coin"))
        self.startcli.setText(_translate("Little_Lambo_CoinWindow", "Start-CLI"))
        self.startgui.setText(_translate("Little_Lambo_CoinWindow", "Start-GUI"))
        self.log.setText(_translate("Little_Lambo_CoinWindow", "Log"))
        self.challenges.setText(_translate("Little_Lambo_CoinWindow", "Challenges"))
        self.stop.setText(_translate("Little_Lambo_CoinWindow", "Stop"))
        self.terminal.setText(_translate("Little_Lambo_CoinWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("Little_Lambo_CoinWindow", "Dashboard"))
        self.genkey.setText(_translate("Little_Lambo_CoinWindow", "Generate Key"))
        self.gettransactions.setText(_translate("Little_Lambo_CoinWindow", "Get Transactions"))
        self.getaddress.setText(_translate("Little_Lambo_CoinWindow", "Get Address"))
        self.mnemonic.setText(_translate("Little_Lambo_CoinWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("Little_Lambo_CoinWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("Little_Lambo_CoinWindow", "Add Key"))
        self.keysshow.setText(_translate("Little_Lambo_CoinWindow", "Little_Lambo_Coin Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("Little_Lambo_CoinWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("Little_Lambo_CoinWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("Little_Lambo_CoinWindow", "Close Full-Node 28515"))
        self.listports.setText(_translate("Little_Lambo_CoinWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("Little_Lambo_CoinWindow", "Close Farmer 28517"))
        self.closewalletport.setText(_translate("Little_Lambo_CoinWindow", "Close Wallet 28519"))
        self.closeharvesterport.setText(_translate("Little_Lambo_CoinWindow", "Close Harvester 28519"))
        self.closedaemonport.setText(_translate("Little_Lambo_CoinWindow", "Close Daemon 25470"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("Little_Lambo_CoinWindow", "Ports"))
        self.installcli.setText(_translate("Little_Lambo_CoinWindow", "Install CLI"))
        self.installgui.setText(_translate("Little_Lambo_CoinWindow", "Install GUI"))
        self.version.setText(_translate("Little_Lambo_CoinWindow", "Little_Lambo_Coin Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("Little_Lambo_CoinWindow", "Install"))
        self.uninstallclient.setText(_translate("Little_Lambo_CoinWindow", "UnInstall Little_Lambo_Coin"))
        self.updateclient.setText(_translate("Little_Lambo_CoinWindow", "Update Little_Lambo_Coin"))
        self.deleteclient.setText(_translate("Little_Lambo_CoinWindow", "Delete Little_Lambo_Coin"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("Little_Lambo_CoinWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    Little_Lambo_CoinWindow = QtWidgets.QMainWindow()
    ui = Ui_Little_Lambo_CoinWindow()
    ui.setupUi(Little_Lambo_CoinWindow)
    Little_Lambo_CoinWindow.show()
    sys.exit(app.exec_()) 
