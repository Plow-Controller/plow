...
def updateclient():
    os.system('echo "Lets get Beer updated for you." ; cd ~/beer-blockchain ; . ./activate ; beer stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:55993,15591,15597,15592,15899) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.beernetwork ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.beernetwork -t ~/plow/old-config/ ; rm -f --recursive -d ~/beer-blockchain ; git clone https://github.com/Beer-Network/beer-blockchain.git ; cd ~/beer-blockchain ; sh install.sh ; . ./activate ; beer init ; cd ~/plow/old-config/.beernetwork/mainnet ; mv db wallet -t ~/.beernetwork/mainnet ; cd ~/beer-blockchain ; beer start farmer ; echo "Beer has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.beernetwork/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Beer uninstalled for you." ; cd ~/beer-blockchain ; . ./activate ; beer stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.beernetwork ; mv ~/.beer -t ~/plow/old-config/ ; rm -f --recursive -d ~/beer-blockchain ; echo "Beer has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Beer deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.beernetwork ; mv ~/.beernetwork -t ~/plow/old-config/ ; rm -f --recursive -d ~/beer-blockchain ; echo "Beer has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Beer Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/beer-blockchain ; . ./activate ; beer keys show')
    
def mnemonic():
    os.system('echo "Getting Active Beer Mnemonic Key..." ; cd ~/beer-blockchain ; . ./activate ; beer keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Beer Mnemonic Key..." ; cd ~/beer-blockchain ; . ./activate ; beer generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Beer Keys..." ; cd ~/beer-blockchain ; . ./activate ; beer keys add')
	
def genkey():
    os.system('echo "Generating New Beer Mnemonic key..." ; cd ~/beer-blockchain ; . ./activate ; beer keys generate')

def stop():
    os.system('echo "Stopping Beer..." ; cd ~/beer-blockchain ; . ./activate ; beer stop all')
	
def version():
    os.system('echo "Beer Verion Number..." ; cd ~/beer-blockchain ; . ./activate ; beer version')

def startcli():
    os.system('echo "Starting Beer..." ; cd ~/beer-blockchain ; . ./activate ; beer stop all ; deactivate ; cd ~/ ; cd ~/beer-blockchain ; . ./activate ; beer start farmer')

def chain():
    os.system('echo "Getting The State Of Beer Blockchain..." ; cd ~/beer-blockchain ; . ./activate ; beer show -s')

def connections():
    os.system('echo "Getting Beer Peer Connections..." ; cd ~/beer-blockchain ; . ./activate ; beer show -c')

def wallet():
    os.system('echo "Beer Wallet Is Loading..." ; cd ~/beer-blockchain ; . ./activate ; beer wallet show')

def getaddress():
    os.system('echo "Getting Beer Address..." ; cd ~/beer-blockchain ; . ./activate ; beer wallet get_address')

def gettransactions():
    os.system('echo "Getting Beer Transactions..." ; cd ~/beer-blockchain ; . ./activate ; beer wallet get_transactions')
	
def summary():
    os.system('echo "Beer Farm Summary Loading..." ; cd ~/beer-blockchain ; . ./activate ; beer farm summary')
	
def challenges():
    os.system('echo "Beer Challenges Loading..." ; cd ~/beer-blockchain ; . ./activate ; beer farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Beer Config File..." ; xdg-open ~/.beernetwork/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Beer Log File..." ; xdg-open ~/.beernetwork/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Beer-GUI..." ; cd ~/beer-blockchain ; . ./activate ; cd beer-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Beer-GUI installed for you." ; cd ~/beer-blockchain ; . ./activate ; sh install-gui.sh ; cd beer-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Beer Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:55993) ; echo "Process IDs On Daemon Port 55993 Closed"')             

def closefarmerport():
    os.system('echo "Closing Beer Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:15592) ; echo "Process IDs On Farmer Port 15592 Closed"')

def closeharvesterport():
    os.system('echo "Closing Beer Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:15591) ; echo "Process IDs On Harvester Port 15591 Closed"')

def closefullnodeport():
    os.system('echo "Closing Beer Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:15899) ; echo "Process IDs On Full Node Port 15899 Closed"')

def closewalletport():
    os.system('echo "Closing Beer Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:15597) ; echo "Process IDs on Wallet Port 15597 Closed"')

def listports():
    os.system('echo "List of All Beer Process IDs for Ports, Daemon 55993, Harvester 15591, Wallet 15597, Farmer 15592, Full Node 15899." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:55993,15591,15597,15592,15899')

def closeallport():
    os.system('echo "Closing All Beer Ports..." ; sudo kill -9 $(sudo lsof -t -i:55993,15591,15597,15592,15899) ; echo "All Process IDs on Ports, Daemon 55993, Harvester 15591, Wallet 15597, Farmer 15592, Full Node 15899, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Beer Folder" ; cd ~/beer-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_BeerWindow(object):
    def setupUi(self, BeerWindow):
        BeerWindow.setObjectName("BeerWindow")
        BeerWindow.resize(483, 320)
...
#START MAIN WINDOW
        BeerWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        BeerWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(BeerWindow)
...
#TAB LAYOUT
        ...
        BeerWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(BeerWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(BeerWindow)

    def retranslateUi(self, BeerWindow):
        _translate = QtCore.QCoreApplication.translate
        BeerWindow.setWindowTitle(_translate("BeerWindow", "Beer"))
        self.connections.setText(_translate("BeerWindow", "Connections"))
        self.summary.setText(_translate("BeerWindow", "Farm Summary"))
        self.config.setText(_translate("BeerWindow", "Config"))
        self.wallet.setText(_translate("BeerWindow", "Show Beer Wallet"))
        self.chain.setText(_translate("BeerWindow", "State Of Beer"))
        self.startcli.setText(_translate("BeerWindow", "Start-CLI"))
        self.startgui.setText(_translate("BeerWindow", "Start-GUI"))
        self.log.setText(_translate("BeerWindow", "Log"))
        self.challenges.setText(_translate("BeerWindow", "Challenges"))
        self.stop.setText(_translate("BeerWindow", "Stop"))
        self.terminal.setText(_translate("BeerWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("BeerWindow", "Dashboard"))
        self.genkey.setText(_translate("BeerWindow", "Generate Key"))
        self.gettransactions.setText(_translate("BeerWindow", "Get Transactions"))
        self.getaddress.setText(_translate("BeerWindow", "Get Address"))
        self.mnemonic.setText(_translate("BeerWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("BeerWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("BeerWindow", "Add Key"))
        self.keysshow.setText(_translate("BeerWindow", "Beer Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("BeerWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("BeerWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("BeerWindow", "Close Full-Node 15899"))
        self.listports.setText(_translate("BeerWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("BeerWindow", "Close Farmer 15592"))
        self.closewalletport.setText(_translate("BeerWindow", "Close Wallet 15597"))
        self.closeharvesterport.setText(_translate("BeerWindow", "Close Harvester 15591"))
        self.closedaemonport.setText(_translate("BeerWindow", "Close Daemon 55993"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("BeerWindow", "Ports"))
        self.installcli.setText(_translate("BeerWindow", "Install CLI"))
        self.installgui.setText(_translate("BeerWindow", "Install GUI"))
        self.version.setText(_translate("BeerWindow", "Beer Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("BeerWindow", "Install"))
        self.uninstallclient.setText(_translate("BeerWindow", "UnInstall Beer"))
        self.updateclient.setText(_translate("BeerWindow", "Update Beer"))
        self.deleteclient.setText(_translate("BeerWindow", "Delete Beer"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("BeerWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    BeerWindow = QtWidgets.QMainWindow()
    ui = Ui_BeerWindow()
    ui.setupUi(BeerWindow)
    BeerWindow.show()
    sys.exit(app.exec_()) 
