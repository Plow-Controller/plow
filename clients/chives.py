...
def updateclient():
    os.system('echo "Lets get Chives updated for you." ; cd ~/chives-blockchain ; . ./activate ; chives stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:56900,9648,9649,9647,9699) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.chives ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.chives -t ~/plow/old-config/ ; rm -f --recursive -d ~/chives-blockchain ; git clone https://github.com/HiveProject2021/chives-blockchain.git ; cd ~/chives-blockchain ; sh install.sh ; . ./activate ; chives init ; cd ~/plow/old-config/.chives/mainnet ; mv db wallet -t ~/.chives/mainnet ; cd ~/chives-blockchain ; chives start farmer ; echo "Chives has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.chives/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Chives uninstalled for you." ; cd ~/chives-blockchain ; . ./activate ; chives stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.chives ; mv ~/.chives -t ~/plow/old-config/ ; rm -f --recursive -d ~/chives-blockchain ; echo "Chives has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Chives deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.chives ; mv ~/.chives -t ~/plow/old-config/ ; rm -f --recursive -d ~/chives-blockchain ; echo "Chives has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Chives Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/chives-blockchain ; . ./activate ; chives keys show')
    
def mnemonic():
    os.system('echo "Getting Active Chives Mnemonic Key..." ; cd ~/chives-blockchain ; . ./activate ; chives keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Chives Mnemonic Key..." ; cd ~/chives-blockchain ; . ./activate ; chives generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Chives Keys..." ; cd ~/chives-blockchain ; . ./activate ; chives keys add')
	
def genkey():
    os.system('echo "Generating New Chives Mnemonic key..." ; cd ~/chives-blockchain ; . ./activate ; chives keys generate')

def stop():
    os.system('echo "Stopping Chives..." ; cd ~/chives-blockchain ; . ./activate ; chives stop all')
	
def version():
    os.system('echo "Chives Verion Number..." ; cd ~/chives-blockchain ; . ./activate ; chives version')

def startcli():
    os.system('echo "Starting Chives..." ; cd ~/chives-blockchain ; . ./activate ; chives stop all ; deactivate ; cd ~/ ; cd ~/chives-blockchain ; . ./activate ; chives start farmer')

def chain():
    os.system('echo "Getting The State Of Chives Blockchain..." ; cd ~/chives-blockchain ; . ./activate ; chives show -s')

def connections():
    os.system('echo "Getting Chives Peer Connections..." ; cd ~/chives-blockchain ; . ./activate ; chives show -c')

def wallet():
    os.system('echo "Chives Wallet Is Loading..." ; cd ~/chives-blockchain ; . ./activate ; chives wallet show')

def getaddress():
    os.system('echo "Getting Chives Address..." ; cd ~/chives-blockchain ; . ./activate ; chives wallet get_address')

def gettransactions():
    os.system('echo "Getting Chives Transactions..." ; cd ~/chives-blockchain ; . ./activate ; chives wallet get_transactions')
	
def summary():
    os.system('echo "Chives Farm Summary Loading..." ; cd ~/chives-blockchain ; . ./activate ; chives farm summary')
	
def challenges():
    os.system('echo "Chives Challenges Loading..." ; cd ~/chives-blockchain ; . ./activate ; chives farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Chives Config File..." ; xdg-open ~/.chives/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Chives Log File..." ; xdg-open ~/.chives/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Chives-GUI..." ; cd ~/chives-blockchain ; . ./activate ; cd chives-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Chives-GUI installed for you." ; cd ~/chives-blockchain ; . ./activate ; sh install-gui.sh ; cd chives-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Chives Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:56900) ; echo "Process IDs On Daemon Port 56900 Closed"')             

def closefarmerport():
    os.system('echo "Closing Chives Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:9647) ; echo "Process IDs On Farmer Port 9647 Closed"')

def closeharvesterport():
    os.system('echo "Closing Chives Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:9648) ; echo "Process IDs On Harvester Port 9648 Closed"')

def closefullnodeport():
    os.system('echo "Closing Chives Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:9699) ; echo "Process IDs On Full Node Port 9699 Closed"')

def closewalletport():
    os.system('echo "Closing Chives Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:9649) ; echo "Process IDs on Wallet Port 9649 Closed"')

def listports():
    os.system('echo "List of All Chives Process IDs for Ports, Daemon 56900, Harvester 9648, Wallet 9649, Farmer 9647, Full Node 9699." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:56900,9648,9649,9647,9699')

def closeallport():
    os.system('echo "Closing All Chives Ports..." ; sudo kill -9 $(sudo lsof -t -i:56900,9648,9649,9647,9699) ; echo "All Process IDs on Ports, Daemon 56900, Harvester 9648, Wallet 9649, Farmer 9647, Full Node 9699, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Chives Folder" ; cd ~/chives-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_ChivesWindow(object):
    def setupUi(self, ChivesWindow):
        ChivesWindow.setObjectName("ChivesWindow")
        ChivesWindow.resize(483, 320)
...
#START MAIN WINDOW
        ChivesWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ChivesWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(ChivesWindow)
...
#TAB LAYOUT
        ...
        ChivesWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(ChivesWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(ChivesWindow)

    def retranslateUi(self, ChivesWindow):
        _translate = QtCore.QCoreApplication.translate
        ChivesWindow.setWindowTitle(_translate("ChivesWindow", "Chives"))
        self.connections.setText(_translate("ChivesWindow", "Connections"))
        self.summary.setText(_translate("ChivesWindow", "Farm Summary"))
        self.config.setText(_translate("ChivesWindow", "Config"))
        self.wallet.setText(_translate("ChivesWindow", "Show Chives Wallet"))
        self.chain.setText(_translate("ChivesWindow", "State Of Chives"))
        self.startcli.setText(_translate("ChivesWindow", "Start-CLI"))
        self.startgui.setText(_translate("ChivesWindow", "Start-GUI"))
        self.log.setText(_translate("ChivesWindow", "Log"))
        self.challenges.setText(_translate("ChivesWindow", "Challenges"))
        self.stop.setText(_translate("ChivesWindow", "Stop"))
        self.terminal.setText(_translate("ChivesWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("ChivesWindow", "Dashboard"))
        self.genkey.setText(_translate("ChivesWindow", "Generate Key"))
        self.gettransactions.setText(_translate("ChivesWindow", "Get Transactions"))
        self.getaddress.setText(_translate("ChivesWindow", "Get Address"))
        self.mnemonic.setText(_translate("ChivesWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("ChivesWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("ChivesWindow", "Add Key"))
        self.keysshow.setText(_translate("ChivesWindow", "Chives Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("ChivesWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("ChivesWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("ChivesWindow", "Close Full-Node 9699"))
        self.listports.setText(_translate("ChivesWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("ChivesWindow", "Close Farmer 9647"))
        self.closewalletport.setText(_translate("ChivesWindow", "Close Wallet 9649"))
        self.closeharvesterport.setText(_translate("ChivesWindow", "Close Harvester 9648"))
        self.closedaemonport.setText(_translate("ChivesWindow", "Close Daemon 56900"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("ChivesWindow", "Ports"))
        self.installcli.setText(_translate("ChivesWindow", "Install CLI"))
        self.installgui.setText(_translate("ChivesWindow", "Install GUI"))
        self.version.setText(_translate("ChivesWindow", "Chives Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("ChivesWindow", "Install"))
        self.uninstallclient.setText(_translate("ChivesWindow", "UnInstall Chives"))
        self.updateclient.setText(_translate("ChivesWindow", "Update Chives"))
        self.deleteclient.setText(_translate("ChivesWindow", "Delete Chives"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("ChivesWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ChivesWindow = QtWidgets.QMainWindow()
    ui = Ui_ChivesWindow()
    ui.setupUi(ChivesWindow)
    ChivesWindow.show()
    sys.exit(app.exec_()) 
