...
def updateclient():
    os.system('echo "Lets get Flax updated for you." ; cd ~/flax-blockchain ; . ./activate ; flax stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:56600,6884,6883,6885,6888) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.flax ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.flax -t ~/plow/old-config/ ; rm -f --recursive -d ~/flax-blockchain ; git clone https://github.com/Flax-Network/flax-blockchain.git ; cd ~/flax-blockchain ; sh install.sh ; . ./activate ; flax init ; cd ~/plow/old-config/.flax/mainnet ; mv db wallet -t ~/.flax/mainnet ; cd ~/flax-blockchain ; flax start farmer ; echo "Flax has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.flax/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
...
#uninstall
def uninstallclient():
    os.system('echo "Lets get Flax uninstalled for you." ; cd ~/flax-blockchain ; . ./activate ; flax stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.flax ; mv ~/.flax -t ~/plow/old-config/ ; rm -f --recursive -d ~/flax-blockchain ; echo "Flax has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Flax deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.flax ; mv ~/.flax -t ~/plow/old-config/ ; rm -f --recursive -d ~/flax-blockchain ; echo "Flax has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Flax Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/flax-blockchain ; . ./activate ; flax keys show')
    
def mnemonic():
    os.system('echo "Getting Active Flax Mnemonic Key..." ; cd ~/flax-blockchain ; . ./activate ; flax keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Flax Mnemonic Key..." ; cd ~/flax-blockchain ; . ./activate ; flax generate_and_print')

def addkey():
    os.system('echo "Please Wait For Prompt To Add Existing Flax Keys..." ; cd ~/flax-blockchain ; . ./activate ; flax keys add')
	
def genkey():
    os.system('echo "Generating New Flax Mnemonic key..." ; cd ~/flax-blockchain ; . ./activate ; flax keys generate')

def stop():
    os.system('echo "Stopping Flax..." ; cd ~/flax-blockchain ; . ./activate ; flax stop all')
	
def version():
    os.system('echo "Flax Verion Number..." ; cd ~/flax-blockchain ; . ./activate ; flax version')

def startcli():
    os.system('echo "Starting Flax..." ; cd ~/flax-blockchain ; . ./activate ; flax stop all ; deactivate ; cd ~/ ; cd ~/flax-blockchain ; . ./activate ; flax start farmer')

def chain():
    os.system('echo "Getting The State Of Flax Blockchain..." ; cd ~/flax-blockchain ; . ./activate ; flax show -s')

def connections():
    os.system('echo "Getting Flax Peer Connections..." ; cd ~/flax-blockchain ; . ./activate ; flax show -c')

def wallet():
    os.system('echo "Flax Wallet Is Loading..." ; cd ~/flax-blockchain ; . ./activate ; flax wallet show')

def getaddress():
    os.system('echo "Getting Flax Address..." ; cd ~/flax-blockchain ; . ./activate ; flax wallet get_address')

def gettransactions():
    os.system('echo "Getting Flax Transactions..." ; cd ~/flax-blockchain ; . ./activate ; flax wallet get_transactions')
	
def summary():
    os.system('echo "Flax Farm Summary Loading..." ; cd ~/flax-blockchain ; . ./activate ; flax farm summary')
	
def challenges():
    os.system('echo "Flax Challenges Loading..." ; cd ~/flax-blockchain ; . ./activate ; flax farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Flax Config File..." ; xdg-open ~/.flax/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Flax Log File..." ; xdg-open ~/.flax/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Flax-GUI..." ; cd ~/flax-blockchain ; . ./activate ; cd flax-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Flax-GUI installed for you." ; cd ~/flax-blockchain ; . ./activate ; sh install-gui.sh ; cd flax-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Flax Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:56600) ; echo "Process IDs On Daemon Port 56600 Closed"')             

def closefarmerport():
    os.system('echo "Closing Flax Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:6885) ; echo "Process IDs On Farmer Port 6885 Closed"')

def closeharvesterport():
    os.system('echo "Closing Flax Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:6884) ; echo "Process IDs On Harvester Port 6884 Closed"')

def closefullnodeport():
    os.system('echo "Closing Flax Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:6888) ; echo "Process IDs On Full Node Port 6888 Closed"')

def closewalletport():
    os.system('echo "Closing Flax Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:6883) ; echo "Process IDs on Wallet Port 6883 Closed"')

def listports():
    os.system('echo "List of All Flax Process IDs for Ports, Daemon 56600, Harvester 6884, Wallet 6883, Farmer 6885, Full Node 6888." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:56600,6884,6883,6885,6888')

def closeallport():
    os.system('echo "Closing All Flax Ports..." ; sudo kill -9 $(sudo lsof -t -i:56600,6884,6883,6885,6888) ; echo "All Process IDs on Ports, Daemon 56600, Harvester 6884, Wallet 6883, Farmer 6885, Full Node 6888, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Flax Folder" ; cd ~/flax-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_FlaxWindow(object):
    def setupUi(self, FlaxWindow):
        FlaxWindow.setObjectName("FlaxWindow")
        FlaxWindow.resize(483, 320)
...
#START MAIN WINDOW
        FlaxWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        FlaxWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(FlaxWindow)
...
#TAB LAYOUT
        ...
        FlaxWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(FlaxWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(FlaxWindow)

    def retranslateUi(self, FlaxWindow):
        _translate = QtCore.QCoreApplication.translate
        FlaxWindow.setWindowTitle(_translate("FlaxWindow", "Flax"))
        self.connections.setText(_translate("FlaxWindow", "Connections"))
        self.summary.setText(_translate("FlaxWindow", "Farm Summary"))
        self.config.setText(_translate("FlaxWindow", "Config"))
        self.wallet.setText(_translate("FlaxWindow", "Show Flax Wallet"))
        self.chain.setText(_translate("FlaxWindow", "State Of Flax"))
        self.startcli.setText(_translate("FlaxWindow", "Start-CLI"))
        self.startgui.setText(_translate("FlaxWindow", "Start-GUI"))
        self.log.setText(_translate("FlaxWindow", "Log"))
        self.challenges.setText(_translate("FlaxWindow", "Challenges"))
        self.stop.setText(_translate("FlaxWindow", "Stop"))
        self.terminal.setText(_translate("FlaxWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("FlaxWindow", "Dashboard"))
        self.genkey.setText(_translate("FlaxWindow", "Generate Key"))
        self.gettransactions.setText(_translate("FlaxWindow", "Get Transactions"))
        self.getaddress.setText(_translate("FlaxWindow", "Get Address"))
        self.mnemonic.setText(_translate("FlaxWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("FlaxWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("FlaxWindow", "Add Key"))
        self.keysshow.setText(_translate("FlaxWindow", "Flax Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("FlaxWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("FlaxWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("FlaxWindow", "Close Full-Node 6888"))
        self.listports.setText(_translate("FlaxWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("FlaxWindow", "Close Farmer 6885"))
        self.closewalletport.setText(_translate("FlaxWindow", "Close Wallet 6883"))
        self.closeharvesterport.setText(_translate("FlaxWindow", "Close Harvester 6884"))
        self.closedaemonport.setText(_translate("FlaxWindow", "Close Daemon 56600"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("FlaxWindow", "Ports"))
        self.installcli.setText(_translate("FlaxWindow", "Install CLI"))
        self.installgui.setText(_translate("FlaxWindow", "Install GUI"))
        self.version.setText(_translate("FlaxWindow", "Flax Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("FlaxWindow", "Install"))
        self.uninstallclient.setText(_translate("FlaxWindow", "UnInstall Flax"))
        self.updateclient.setText(_translate("FlaxWindow", "Update Flax"))
        self.deleteclient.setText(_translate("FlaxWindow", "Delete Flax"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("FlaxWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    FlaxWindow = QtWidgets.QMainWindow()
    ui = Ui_FlaxWindow()
    ui.setupUi(FlaxWindow)
    FlaxWindow.show()
    sys.exit(app.exec_()) 
