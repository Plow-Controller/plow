...
def updateclient():
    os.system('echo "Lets get Fishery updated for you." ; cd ~/Fishery-blockchain ; . ./activate ; fishery stop all ; deactivate ; sudo kill -9 $(sudo lsof -t -i:56500,4899,4893,4895,4499) ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.fishery ; echo "Saving Mainnet folder in ~plow/old-config" ; mv ~/.fishery -t ~/plow/old-config/ ; rm -f --recursive -d ~/Fishery-blockchain ; git clone https://github.com/fisheryffk/Fishery-blockchain.git ; cd ~/Fishery-blockchain ; sh install.sh ; . ./activate ; fishery init ; cd ~/plow/old-config/.fishery/mainnet ; mv db wallet -t ~/.fishery/mainnet ; cd ~/Fishery-blockchain ; fishery start farmer ; echo "Fishery has been Updated! The old Mainnet folder is saved in ~/plow/old-config, Add Your Plot Directories!" ; xdg-open ~/.fishery/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
    
def installcli():
    os.system('echo "Lets get Fishery installed for you." ; cd ~/ ; sudo kill -9 $(sudo lsof -t -i:56500,4899,4893,4895,4499) ; git clone https://github.com/fisheryffk/Fishery-blockchain.git ; cd ~/Fishery-blockchain ; sh install.sh ; . ./activate ; fishery init ; cd ~/plow/old-config/.fishery/mainnet ; mv db wallet -t ~/.fishery/mainnet ; cd ~/Fishery-blockchain ; fishery keys add ; fishery start farmer ; echo "Fishery has been installed, Add Your Plot Directories!!" ; xdg-open ~/.fishery/mainnet/config/config.yaml ; xdg-open ~/plow/plot-directories.yaml')
    
#uninstall
def uninstallclient():
    os.system('echo "Lets get Fishery uninstalled for you." ; cd ~/Fishery-blockchain ; . ./activate ; fishery stop all ; deactivate ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.fishery ; mv ~/.fishery -t ~/plow/old-config/ ; rm -f --recursive -d ~/Fishery-blockchain ; echo "Fishery has been Uninstalled. Old Mainnet folder is saved in ~/plow/old-config"')
    
def deleteclient():
    os.system('echo "Lets get Fishery deleted for you." ; cd ~/ ; mkdir ~/plow ; mkdir ~/plow/old-config ; rm -f --recursive -d ~/plow/old-config/.fishery ; mv ~/.fishery -t ~/plow/old-config/ ; rm -f --recursive -d ~/Fishery-blockchain ; echo "Fishery has been Deleted. The old Mainnet folder has been saved in ~/plow/old-config"') 

def keysshow():
    os.system('echo "Getting Fishery Fingerprint, Pool & Farmer Public Plot Keys..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery keys show')
    
def mnemonic():
    os.system('echo "Getting Active Fishery Mnomonic Key..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery keys show --show-mnemonic-seed')
	
def genandprintkey():
    os.system('echo "Generating and Printing New Fishery Mnemonic Key..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery generate_and_print')

def addkey():
    os.system('echo "Add Existing Fishery Keys..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery keys add')
	
def genkey():
    os.system('echo "Generating New Fishery Mnemonic key..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery keys generate')

def stop():
    os.system('echo "Stopping Fishery..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery stop all')
	
def version():
    os.system('echo "Fishery Verion Number..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery version')

def startcli():
    os.system('echo "Starting Fishery..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery stop all ; deactivate ; cd ~/ ; cd ~/Fishery-blockchain ; . ./activate ; fishery start farmer')

def chain():
    os.system('echo "Getting The State Of Fishery Blockchain..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery show -s')

def connections():
    os.system('echo "Getting Fishery Peer Connections..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery show -c')

def wallet():
    os.system('echo "Fishery Wallet Is Loading..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery wallet show')

def getaddress():
    os.system('echo "Getting Fishery Address..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery wallet get_address')

def gettransactions():
    os.system('echo "Getting Fishery Transactions..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery wallet get_transactions')
	
def summary():
    os.system('echo "Fishery Farm Summary Loading..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery farm summary')
	
def challenges():
    os.system('echo "Fishery Challenges Loading..." ; cd ~/Fishery-blockchain ; . ./activate ; fishery farm challenges ; echo "End Of Challenges"')
    
def config():
    os.system('echo "Opening Fishery Config File..." ; xdg-open ~/.fishery/mainnet/config/config.yaml')
    
def log():
    os.system('echo "Opening Fishery Log File..." ; xdg-open ~/.fishery/mainnet/log/debug.log')
    
def startgui():
    os.system('echo "Starting Fishery-GUI..." ; cd ~/Fishery-blockchain ; . ./activate ; cd fishery-blockchian-gui ; npm run electron')  
    
def installgui():
    os.system('echo "Lets get Fishery-GUI installed for you." ; cd ~/Fishery-blockchain ; . ./activate ; sh install-gui.sh ; cd fishery-blockchian-gui ; npm run electron')
  
def closedaemonport():
    os.system('echo "Closing Fishery Daemon Port..." ; sudo kill -9 $(sudo lsof -t -i:56500) ; echo "Process IDs On Daemon Port 56500 Closed"')             

def closefarmerport():
    os.system('echo "Closing Fishery Farmer Port..." ; sudo kill -9 $(sudo lsof -t -i:4895) ; echo "Process IDs On Farmer Port 4895 Closed"')

def closeharvesterport():
    os.system('echo "Closing Fishery Harvester Port..." ; sudo kill -9 $(sudo lsof -t -i:4899) ; echo "Process IDs On Harvester Port 4899 Closed"')

def closefullnodeport():
    os.system('echo "Closing Fishery Full-Node Port..." ; sudo kill -9 $(sudo lsof -t -i:4499) ; echo "Process IDs On Full Node Port 4499 Closed"')

def closewalletport():
    os.system('echo "Closing Fishery Wallet Port..." ; sudo kill -9 $(sudo lsof -t -i:4893) ; echo "Process IDs on Wallet Port 4893 Closed"')

def listports():
    os.system('echo "List of All Fishery Process IDs for Ports, Daemon 56500, Harvester 4899, Wallet 4893, Farmer 4895, Full Node 4499." ; echo "For more details on Active Process IDs, use Extras Tab on Main Window." ; sudo lsof -t -i:56500,4899,4893,4895,4499')

def closeallport():
    os.system('echo "Closing All Fishery Ports..." ; sudo kill -9 $(sudo lsof -t -i:56500,4899,4893,4895,4499) ; echo "All Process IDs on Ports, Daemon 56500, Harvester 4899, Wallet 4893, Farmer 4895, Full Node 4499, are closed"')

def terminal():
    subprocess.call('echo "Opening Terminal in Fishery Folder" ; cd ~/Fishery-blockchain ; x-terminal-emulator -- ', shell =True)


class Ui_FisheryWindow(object):
    def setupUi(self, FisheryWindow):
        FisheryWindow.setObjectName("FisheryWindow")
        FisheryWindow.resize(483, 320)
...
#START MAIN WINDOW
        FisheryWindow.setPalette(palette)
#ICON
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/theme/plow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        FisheryWindow.setWindowIcon(icon)
#MAIN WINDOWS SPECS
        self.centralwidget = QtWidgets.QWidget(FisheryWindow)
...
#TAB LAYOUT
        ...
        FisheryWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(FisheryWindow)
        self.MainTab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(FisheryWindow)

    def retranslateUi(self, FisheryWindow):
        _translate = QtCore.QCoreApplication.translate
        FisheryWindow.setWindowTitle(_translate("FisheryWindow", "Fishery"))
        self.connections.setText(_translate("FisheryWindow", "Connections"))
        self.summary.setText(_translate("FisheryWindow", "Farm Summary"))
        self.config.setText(_translate("FisheryWindow", "Config"))
        self.wallet.setText(_translate("FisheryWindow", "Show Fishery Wallet"))
        self.chain.setText(_translate("FisheryWindow", "State Of Fishery"))
        self.startcli.setText(_translate("FisheryWindow", "Start-CLI"))
        self.startgui.setText(_translate("FisheryWindow", "Start-GUI"))
        self.log.setText(_translate("FisheryWindow", "Log"))
        self.challenges.setText(_translate("FisheryWindow", "Challenges"))
        self.stop.setText(_translate("FisheryWindow", "Stop"))
        self.terminal.setText(_translate("FisheryWindow", "Open Terminal"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.dashboardtab), _translate("FisheryWindow", "Dashboard"))
        self.genkey.setText(_translate("FisheryWindow", "Generate Key"))
        self.gettransactions.setText(_translate("FisheryWindow", "Get Transactions"))
        self.getaddress.setText(_translate("FisheryWindow", "Get Address"))
        self.mnemonic.setText(_translate("FisheryWindow", "Show Mnemonic"))
        self.genandprintkey.setText(_translate("FisheryWindow", "Generate And Print Key"))
        self.addkey.setText(_translate("FisheryWindow", "Add Key"))
        self.keysshow.setText(_translate("FisheryWindow", "Fishery Keys Show"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.keys), _translate("FisheryWindow", "Wallet and Keys"))
        self.closeallport.setText(_translate("FisheryWindow", "Close All Ports"))
        self.closefullnodeport.setText(_translate("FisheryWindow", "Close Full-Node 4499"))
        self.listports.setText(_translate("FisheryWindow", "List Active PIDs"))
        self.closefarmerport.setText(_translate("FisheryWindow", "Close Farmer 4895"))
        self.closewalletport.setText(_translate("FisheryWindow", "Close Wallet 4893"))
        self.closeharvesterport.setText(_translate("FisheryWindow", "Close Harvester 4899"))
        self.closedaemonport.setText(_translate("FisheryWindow", "Close Daemon 56500"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.portstab), _translate("FisheryWindow", "Ports"))
        self.installcli.setText(_translate("FisheryWindow", "Install CLI"))
        self.installgui.setText(_translate("FisheryWindow", "Install GUI"))
        self.version.setText(_translate("FisheryWindow", "Fishery Version"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.installtab), _translate("FisheryWindow", "Install"))
        self.uninstallclient.setText(_translate("FisheryWindow", "UnInstall Fishery"))
        self.updateclient.setText(_translate("FisheryWindow", "Update Fishery"))
        self.deleteclient.setText(_translate("FisheryWindow", "Delete Fishery"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.uninstalltab), _translate("FisheryWindow", "Update/Uninstall"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    FisheryWindow = QtWidgets.QMainWindow()
    ui = Ui_FisheryWindow()
    ui.setupUi(FisheryWindow)
    FisheryWindow.show()
    sys.exit(app.exec_()) 
